...
def checkout_harness(sha):
    ...
    if kind == "platform":
        evidence_scripts += (
            ...
            "scripts/proof/f26-read-notice/app-identity.mjs",
            "scripts/proof/f26-read-notice/artifact-recipient.pem",
            "scripts/proof/f26-read-notice/command-read.mjs",
            "scripts/proof/f26-read-notice/command-read.test.mjs",
            "scripts/proof/f26-read-notice/evidence-archive.mjs",
            "scripts/proof/f26-read-notice/evidence-archive.test.mjs",
            "scripts/proof/f26-read-notice/proof-admission.mjs",
            "scripts/proof/f26-read-notice/proof-admission.test.mjs",
