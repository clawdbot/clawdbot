    ...
    const cases = [
      ...
      },
      {
        ...
        source: [
          ...
          "$previousUserConfigLower = $env:npm_config_userconfig",
          "$previousPnpmUserConfig = $env:PNPM_CONFIG_USERCONFIG",
          "$previousPnpmUserConfigLower = $env:pnpm_config_userconfig",
          "$previousPnpmAuthFile = $env:PNPM_CONFIG_NPMRC_AUTH_FILE",
          "$previousPnpmAuthFileLower = $env:pnpm_config_npmrc_auth_file",
          "function Invoke-NpmCommand {",
          "  param([string[]]$Arguments = @(), [string]$CommandPath, [string]$WorkingDirectory)",
          ...
          "  Remove-Item Env:npm_config_userconfig -ErrorAction SilentlyContinue",
          "  Remove-Item Env:PNPM_CONFIG_USERCONFIG -ErrorAction SilentlyContinue",
          "  Remove-Item Env:pnpm_config_userconfig -ErrorAction SilentlyContinue",
          "  Remove-Item Env:PNPM_CONFIG_NPMRC_AUTH_FILE -ErrorAction SilentlyContinue",
          "  Remove-Item Env:pnpm_config_npmrc_auth_file -ErrorAction SilentlyContinue",
          ...
          "  Remove-Item Env:NPM_CONFIG_USERCONFIG -ErrorAction SilentlyContinue",
          "  $env:PNPM_CONFIG_USERCONFIG = $userConfig",
          "  if (Test-ShouldPreferOfflinePnpmInstall -ProjectDir $project) { throw 'pnpm user config was ignored' }",
          "  Remove-Item Env:PNPM_CONFIG_USERCONFIG -ErrorAction SilentlyContinue",
          "  $env:pnpm_config_userconfig = $userConfig",
          "  if (Test-ShouldPreferOfflinePnpmInstall -ProjectDir $project) { throw 'lowercase pnpm user config was ignored' }",
          "  Remove-Item Env:pnpm_config_userconfig -ErrorAction SilentlyContinue",
          "  $env:PNPM_CONFIG_NPMRC_AUTH_FILE = $userConfig",
          "  if (Test-ShouldPreferOfflinePnpmInstall -ProjectDir $project) { throw 'pnpm auth config was ignored' }",
          "  Remove-Item Env:PNPM_CONFIG_NPMRC_AUTH_FILE -ErrorAction SilentlyContinue",
          "  $env:pnpm_config_npmrc_auth_file = $userConfig",
          "  if (Test-ShouldPreferOfflinePnpmInstall -ProjectDir $project) { throw 'lowercase pnpm auth config was ignored' }",
          "  Remove-Item Env:pnpm_config_npmrc_auth_file -ErrorAction SilentlyContinue",
          "} finally {",
          ...
          "  $env:npm_config_userconfig = $previousUserConfigLower",
          "  $env:PNPM_CONFIG_USERCONFIG = $previousPnpmUserConfig",
          "  $env:pnpm_config_userconfig = $previousPnpmUserConfigLower",
          "  $env:PNPM_CONFIG_NPMRC_AUTH_FILE = $previousPnpmAuthFile",
          "  $env:pnpm_config_npmrc_auth_file = $previousPnpmAuthFileLower",
