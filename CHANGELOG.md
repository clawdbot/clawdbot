...
- Docs: clarify WhatsApp personal-number mode UX expectations - no separate bot contact, self-chat is expected behavior. (#1980) Thanks @ashimgupta39. https://docs.clawd.bot/channels/whatsapp
