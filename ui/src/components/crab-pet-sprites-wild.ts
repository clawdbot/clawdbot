...
export function FLATPACK_CRAB(openEyeStyle: string, closedEyeStyle: string): TemplateResult {
  return svg`
    <g class="crab-flatpack">
      <path
      ...
      <g class="crab-eye-open" style=${openEyeStyle}>
        ...
        <circle cx="40.2" cy="32.8" r="1.7" fill="var(--crab-glint, #00e5cc)" />
        <circle cx="58.2" cy="32.8" r="1.7" fill="var(--crab-glint, #00e5cc)" />
      </g>
      <g
        class="crab-eye-closed"
        stroke="#0a1014"
        stroke-width="2.5"
      ...
      <g fill="var(--crab-shell)" stroke="#8a7c5f" stroke-width="1.5" stroke-dasharray="4 3">
      ...
      <path
        class="crab-flatpack__allen-key"
...
export function LOADING_CRAB(openEyeStyle: string, closedEyeStyle: string): TemplateResult {
  return svg`
    <!-- Skeleton placeholders stay neutral instead of inheriting palette colors. -->
    <g class="crab-skeleton">
      <rect class="crab-skeleton__block" style="--i:0" x="24" y="18" width="72" height="64" rx="10" fill="#2f3542" />
      <rect class="crab-skeleton__block" style="--i:1" x="2" y="43" width="24" height="20" rx="8" fill="#39404f" />
      <rect class="crab-skeleton__block" style="--i:2" x="94" y="43" width="24" height="20" rx="8" fill="#39404f" />
      <path class="crab-skeleton__block" style="--i:3" d="M45 21 L34 7" stroke="#39404f" stroke-width="6" stroke-linecap="round" />
      <path class="crab-skeleton__block" style="--i:4" d="M75 21 L86 7" stroke="#39404f" stroke-width="6" stroke-linecap="round" />
      <rect class="crab-skeleton__block" style="--i:5" x="31" y="79" width="10" height="22" rx="4" fill="#2f3542" />
      <rect class="crab-skeleton__block" style="--i:6" x="46" y="79" width="10" height="24" rx="4" fill="#39404f" />
      <rect class="crab-skeleton__block" style="--i:7" x="64" y="79" width="10" height="24" rx="4" fill="#39404f" />
      <rect class="crab-skeleton__block" style="--i:8" x="79" y="79" width="10" height="22" rx="4" fill="#2f3542" />
      <g class="crab-eye-open" style=${openEyeStyle}>
        <circle cx="47" cy="43" r="5" fill="#4a5364" />
        <circle cx="73" cy="43" r="5" fill="#4a5364" />
      </g>
      <g class="crab-eye-closed" style=${closedEyeStyle} fill="#4a5364">
...
export function ACTUAL_CRAB(openEyeStyle: string, closedEyeStyle: string): TemplateResult {
  return svg`
    <g class="crab-actual">
      ...
      <g class="crab-actual__tail" fill="#3f9d63" stroke="#6f281d" stroke-width="1.4">
      ...
      <g class="crab-eye-closed" style=${closedEyeStyle} fill="none" stroke="#17100e" stroke-width="2" stroke-linecap="round">
...
export function BALLOON_CRAB(openEyeStyle: string, closedEyeStyle: string): TemplateResult {
  return svg`
    <g class="crab-balloon">
      <g fill="none" stroke="var(--crab-shell)" stroke-width="4" stroke-linecap="round">
        <path d="M48 13 Q45 5 42 3" />
        <path d="M72 13 Q75 5 78 3" />
      </g>

      <g class="crab-claw crab-claw--l" fill="var(--crab-claw)">
        <ellipse cx="29" cy="29" rx="9" ry="7" transform="rotate(-20 29 29)" />
        <ellipse cx="20" cy="35" rx="8" ry="6" transform="rotate(18 20 35)" />
      </g>
      <g class="crab-claw crab-claw--r" fill="var(--crab-claw)">
      ...
      <g class="crab-eye-open" style=${openEyeStyle}>
        ...
        <circle cx="51.3" cy="28.7" r="1.8" fill="var(--crab-glint, #00e5cc)" />
        <circle cx="71.3" cy="28.7" r="1.8" fill="var(--crab-glint, #00e5cc)" />
      </g>
      <g
        class="crab-eye-closed"
        style=${closedEyeStyle}
...
export function ASCII_CRAB(openEyeStyle: string, closedEyeStyle: string): TemplateResult {
  return svg`
    ...
    >
      ...
      <g class="crab-eye-closed" style=${closedEyeStyle}>
        <text x="60" y="45">(-)     (-)</text>
      </g>
      <text x="60" y="59">(    '---'    )</text>
...
export function PORTAL_CRAB(openEyeStyle: string, closedEyeStyle: string): TemplateResult {
  return svg`
    <g class="crab-portal">
      <ellipse
        class="crab-portal-ring crab-portal-ring--blue"
        cx="30"
        cy="50"
        rx="14"
        ry="30"
      ...
      <g class="crab-eye-open" style=${openEyeStyle}>
        ...
        <circle cx="46" cy="38" r="1.5" fill="var(--crab-glint, #00e5cc)" />
        <circle cx="58" cy="36" r="1.5" fill="var(--crab-glint, #00e5cc)" />
      </g>
      <g
        class="crab-eye-closed"
        style=${closedEyeStyle}
...
export function TINFOIL_PARTS(showHat: boolean): TemplateResult {
  return svg`
    <g class="crab-tinfoil" fill="none" stroke="#c9d2da" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
export const NOTEXTURE_CHECKER = svg`
  <g class="crab-notexture" shape-rendering="crispEdges">
...
export const CHIMERA_STITCHES = svg`
  <g class="crab-chimera-stitches" fill="none" stroke="#4a3f3a" stroke-width="1.8" stroke-linecap="round">
