...
export const toolIcons = {
  ...
  claw: strokeIcon(svg` <path
      d="M8.2 10 A5.2 5.2 0 1 0 8.2 20.4 A5.2 5.2 0 0 0 8.2 10 Z M10.5 19.8 C13.8 20.6 17.3 19.6 19.8 16.8 L18.6 15 L16.3 16.2 L15.2 14.3 L13 15.6 Z"
    />
    <path
      class="claw-icon__jaw"
      d="M5.6 12.2 C5.8 7.2 10 3.6 14.3 4 C17.6 4.3 20 6.4 20.6 9.2 C19 8.7 17.3 8.6 15.7 8.9 L14.9 7.2 L13.1 9.2 C11.7 10 10.4 11.1 9.8 12.4 L6.8 13 Z"
    />`),
