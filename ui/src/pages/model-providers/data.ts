 ...
 * has refreshable auth state, catalog models (the default models.list view only
 * contains configured or auth-backed entries), a live usage snapshot, or
 * recorded local spend. Model presence alone is enough: a configured
