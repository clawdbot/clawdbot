...
const APPEARANCE_SETTINGS_BLOCKS = {
  ...
  chat: {
    ...
    searchKeys: [
      ...
      "configView.chatPrefs.hint",
    ],
    aliases:
      "keyboard enter follow-up followup steer queue microphone voice audio input codex claude terminal viewer camera photo dictation message width css",
  },
  sidebar: {
    routeId: "appearance",
    ...
    aliases: "live activity session sidebar customize",
  },
  sessionObserver: {
    routeId: "appearance",
    labelKey: "configView.sessionObserver.title",
    search: "?section=__appearance__",
    hash: `#${APPEARANCE_SETTINGS_TARGET_IDS.sidebar}`,
    searchKeys: [
      ...
      "configView.sessionObserver.modelDisabled",
      "configView.sessionObserver.modelUnavailable",
    ],
    aliases: "summary digest status utility small model auto",
  },
  connection: {
    routeId: "appearance",
