...
export const LAB_FEATURES = [
  ...
  {
    id: "trajectory",
    title: () => t("labsPage.trajectory.title"),
    description: () => t("labsPage.trajectory.description"),
    docsUrl: "https://docs.openclaw.ai/tools/trajectory",
    configPath: ["gateway", "controlUi", "trajectory"],
    onValue: true,
    offValue: false,
    activeValues: [true],
    readEnabled: null,
