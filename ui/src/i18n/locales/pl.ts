...
export const pl: TranslationMap = {
  ...
  sessionsView: {
    ...
    showCronSessions: "Pokaż sesje automatyzacji",
  ...
  agents: {
    ...
    cronPanel: {
      ...
      schedulerSubtitle: "Stan automatyzacji Gateway.",
      jobs: "Zadania",
      nextWake: "Następne wybudzenie",
      agentJobsTitle: "Automatyzacje agenta",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Wypatrzono błyszczącego {date}",
  ...
  subtitles: {
    ...
    tasks: "Zadania w tle: subagenci, uruchomienia automatyzacji, CLI.",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Przygotuj zaufane wspomnienia z wcześniejszych sesji agenta. Śnienie przenosi przydatne wspomnienia do pamięci długoterminowej.",
      dateRange: "Zakres dat sesji",
      dateRangeHint: "Pozostaw dowolną datę pustą, aby przeskanować cały dostępny zakres.",
      from: "Od",
      to: "Do",
      actions: "Uzupełnij wstecznie",
      preview: "Podgląd",
      previewing: "Generowanie podglądu…",
      apply: "Zastosuj",
      applying: "Stosowanie…",
      rollback: "Wycofaj",
      previewSummary: "{candidates} kandydatów z {days} dni",
      previewTruncated:
        "Ten podgląd pokazuje pierwszą ograniczoną partię. Zastosowanie będzie kontynuowane dla pozostałych kandydatów.",
      candidateCount: "{count} kandydatów",
      noCandidates: "Nie znaleziono nowych zaufanych kandydatów na sesje.",
      progress: "Przetworzono dni: {days} · przygotowano: {staged}",
      processedCandidates: "Przetworzono kandydatów na sesje: {count}",
      processedDayCountOne: "Przetworzono {count} dzień",
      processedDayCount: "Przetworzono dni: {count}",
      complete: "Przygotowano: {count}; promocja odbywa się podczas śnienia",
      rollbackConfirmTitle: "Wycofać uzupełnianie sesji?",
      rollbackConfirmDescription:
        "Usuń wpisy dziennika i przygotowane wspomnienia utworzone przez uzupełnianie sesji dla tego agenta.",
      rollbackWarning:
        "Śledzone kursory sesji pozostaną na miejscu, więc usunięte wpisy nie zostaną ponownie przygotowane.",
      rollbackComplete: "Wycofano uzupełnianie sesji",
      rollbackCounts: "Usunięto wpisy dziennika: {diary} i przygotowane wpisy: {staged}",
      unavailable: "Uzupełnianie sesji jest niedostępne w tym Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  memoryPage: {
    ...
    dreaming: {
      intro:
        "Śnienie działa jako jedna zarządzana automatyzacja we wszystkich przestrzeniach roboczych agentów, dlatego te ustawienia są globalne. Zarządza nimi wtyczka {plugin}.",
      schedule: {
        title: "Harmonogram",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Wyświetl aktywność, koszty i trendy użytkowania.",
    identity: {
      title: "Tożsamość",
  ...
  attention: {
    ...
    cronFailed: "Automatyzacje zakończone niepowodzeniem: {count}",
    cronOverdue: "Zaległe automatyzacje: {count}",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle:
        "Dzienna intensywność użycia tokenów w wybranym zakresie, maksymalnie do jednego roku.",
  ...
  chat: {
    ...
    messages: {
      ...
      actions: "Działania dotyczące wiadomości",
      selectionActions: "Działania dotyczące zaznaczenia",
      moreDetails: "Więcej szczegółów",
      askInSideChat: "Zapytaj na czacie bocznym",
      rewind: "Cofnij",
    ...
    composer: {
      ...
      fallbackPrevious: "Poprzedni model zapasowy: {model}",
