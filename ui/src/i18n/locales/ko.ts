...
export const ko: TranslationMap = {
  ...
  mcpApp: {
    ...
    errors: {
      ...
      invalidSandboxUrl: "MCP App 샌드박스 URL이 올바르지 않습니다",
    },
  },
  githubPreview: {
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        timeout:
          "요청이 30초 후 시간 초과되었습니다. 서버에 변경 사항이 적용되었을 수도 있으므로 다시 시도하기 전에 프로필을 확인하세요.",
        operationFailed: "{prefix}: {error}",
        updateFailed: "프로필 업데이트에 실패했습니다",
        updateFailedStatus: "프로필 업데이트에 실패했습니다({status})",
        ...
        importedFromRelays: "릴레이에서 프로필을 가져왔습니다. 검토한 후 게시하세요.",
        imported: "프로필을 가져왔습니다. 검토한 후 게시하세요.",
      },
    },
  },
  lazyView: {
    ...
    reloading: "다시 불러오는 중…",
    retry: "다시 시도",
    stylesFailed: "스타일을 불러오지 못해 페이지가 올바르게 표시되지 않을 수 있습니다.",
  },
  updates: {
    refreshRequired: "서버가 업데이트되었습니다 — 모든 기능을 사용하려면 새로 고침하세요",
    coalescedRestart:
      "업데이트가 설치되었습니다. Gateway가 이미 재시작 중이며, 다시 연결되면 상태가 새로 고쳐집니다.",
    error: "업데이트 오류: {error}",
    status: "업데이트 {status}: {reason}. {guidance}",
    verificationFailed:
      "업데이트가 설치되었지만 실행 중인 버전이 변경되지 않았습니다 — 재시작이 차단되었을 수 있습니다.",
    verificationFailedWithVersions:
      "업데이트가 설치되었지만 실행 중인 버전이 변경되지 않았습니다 — 재시작이 차단되었을 수 있습니다. 예상 버전: v{expectedVersion}, 실행 중인 버전: v{actualVersion}.",
    handoffTimeout:
      "업데이트 인계가 시작되었지만 다시 연결된 후에도 완료 여부가 보고되지 않았습니다. 최종 결과를 확인하려면 `openclaw update status`를 실행하세요.",
    outcomeUnknown:
      "업데이트 요청이 수락되었을 수 있지만 다시 연결된 후 Gateway가 최종 결과를 보고하지 않았습니다. 다시 시도하기 전에 `openclaw update status`를 실행하세요.",
    failureReasons: {
      dirty: "변경 사항을 커밋하거나 스태시한 후 다시 시도하세요.",
      noUpstream: "업스트림 브랜치를 설정한 후 다시 시도하세요.",
      notGitInstall:
        "git 체크아웃이 아닙니다. 전역 재설치를 위해 CLI에서 `openclaw update`를 실행하세요.",
      notOpenclawRoot:
        "OpenClaw 체크아웃에서 업데이트를 실행하거나 CLI 전역 재설치 경로를 사용하세요.",
      depsInstallFailed: "종속성 설치에 실패했습니다. 설치 오류를 해결한 후 다시 시도하세요.",
      buildFailed: "빌드에 실패했습니다. 빌드 오류를 수정하고 다시 시도하세요.",
      buildDirty:
        "선택한 리비전의 빌드로 인해 체크아웃 파일이 변경되었습니다. 생성된 아티팩트가 포함된 리비전으로 다시 시도하세요.",
      uiBuildFailed: "Control UI 재빌드에 실패했습니다. UI 빌드 오류를 수정하고 다시 시도하세요.",
      globalInstallFailed:
        "전역 패키지 설치가 디스크에서 확인되지 않았습니다. 다시 시도하거나 CLI에서 재설치하세요.",
      restartDisabled:
        "Gateway 재시작이 비활성화되어 업데이트가 적용되지 않았습니다. config에서 재시작을 활성화한 후 다시 시도하세요.",
      restartUnavailable:
        "재시작이 비활성화되어 있고 supervisor가 없는 동안에는 이 전역 설치를 안전하게 교체할 수 없습니다.",
      restartUnhealthy:
        "교체 프로세스가 정상 상태가 되지 않았습니다. 복구할 수 있도록 이전 프로세스가 계속 실행 중입니다.",
      ...
      default: "정확한 실패 원인은 Gateway 로그를 확인하고, 원인을 해결한 후 다시 시도하세요.",
    },
    postRestart: {
      restartUnhealthy:
        "교체 프로세스가 정상 상태가 되지 않았으며 이전 프로세스가 계속 실행 중입니다.",
      default: "교체 실패에 대한 자세한 내용은 Gateway 로그를 확인하세요.",
    },
  },
  nodes: {
    pairing: {
  ...
  agents: {
    ...
    defaults: {
      title: "에이전트 기본값",
      description: "별도로 재정의하지 않는 한 모든 에이전트가 상속하는 기본값입니다.",
    },
    copyId: "Copy ID",
    ...
    cronPanel: {
      ...
      schedulerSubtitle: "Gateway 자동화 상태입니다.",
      jobs: "작업",
      nextWake: "다음 실행",
      agentJobsTitle: "에이전트 자동화",
  ...
  configForm: {
    redactedPlaceholder: "[숨김 처리됨 - 보려면 클릭하여 표시]",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ 희귀 항목 발견 {date}",
      lobsterdexCardCopyLink: "링크 복사",
      lobsterdexOpen: "Lobsterdex 열기",
    },
    security: {
      intro: "Gateway 액세스, 도구 정책, 기기 인증 및 승인을 검토하세요.",
      title: "보안",
  ...
  configView: {
    ...
    appearance: {
      intro: "이 Control UI 클라이언트의 테마, 채팅 및 사이드바 환경설정입니다.",
      theme: "테마",
  ...
  terminal: {
    ...
    uploadTooLarge: "파일이 터미널 업로드 제한인 16 MiB를 초과합니다: {file}",
    uploadUnsafeCmdPath: "% 또는 !가 포함된 업로드 경로는 cmd.exe에 안전하게 삽입할 수 없습니다",
    uploadUnsupportedShell: "지원되지 않는 셸에 업로드 경로를 안전하게 삽입할 수 없습니다: {shell}",
  },
  browser: {
    title: "브라우저",
    toggle: "브라우저 패널 전환",
    ...
    errors: {
      requestFailed: "브라우저 요청에 실패했습니다: {error}",
      screenshotPathMissing: "브라우저 스크린샷에서 미디어 경로를 반환하지 않았습니다.",
      screenshotFetchTimedOut: "스크린샷 가져오기 시간이 초과되었습니다.",
      screenshotFetchFailed: "스크린샷을 가져오지 못했습니다({status}).",
      screenshotReadFailed: "스크린샷을 읽지 못했습니다.",
      screenshotDecodeFailed: "스크린샷을 디코딩하지 못했습니다.",
  ...
  subtitles: {
    ...
    usage: "API 사용량 및 비용.",
    cron: "웨이크업 및 반복 실행.",
    tasks: "백그라운드 작업: 하위 에이전트, 자동화 실행, CLI.",
    ...
    automation: "명령어, 훅, 자동화 및 플러그인.",
    mcp: "MCP 서버, 인증, 도구 및 진단.",
    memory: "메모리 엔진, 백엔드, 검색 및 드리밍.",
    talk: "실시간 음성: 제공업체, 모델 및 화자 음성.",
  ...
  modelSetup: {
    ...
    required: {
      title: "구성된 AI 제공업체가 없습니다",
      body: "OpenClaw에서 이 에이전트에 구성된 제공업체와 모델을 찾을 수 없습니다. 대화를 시작하기 전에 추가하세요.",
      action: "제공업체 구성",
    },
    connectionFailure: {
      title: "OpenClaw에서 구성된 AI를 사용할 수 없습니다",
      body: "이 에이전트에 제공업체와 모델이 선택되어 있지만 연결에 실패했습니다. 제공업체 로그인 또는 API 키, 모델 액세스 권한 및 서비스 상태를 확인한 후 다시 시도하세요.",
      action: "제공업체 설정 확인",
    },
    ...
    prepare: {
      ...
      llamaCppHint: "약 5.0GB 로컬 모델을 다운로드하며, 16GB RAM이 필요합니다",
    },
    manual: {
  ...
  memoryImport: {
    ...
    backfill: {
      title: "과거 세션에서 가져오기",
      subtitle:
        "이전 에이전트 세션에서 신뢰할 수 있는 메모리를 준비합니다. 드리밍을 통해 유용한 메모리를 장기 메모리로 승격합니다.",
      dateRange: "세션 날짜 범위",
      dateRangeHint: "사용 가능한 전체 범위를 스캔하려면 시작일이나 종료일 중 하나를 비워 두세요.",
      from: "시작일",
      to: "종료일",
      actions: "과거 데이터 채우기",
      preview: "미리보기",
      ...
      applying: "적용 중…",
      rollback: "롤백",
      previewSummary: "{days}일간 후보 {candidates}개",
      previewTruncated:
        "이 미리보기에는 제한된 첫 번째 배치가 표시됩니다. 적용하면 나머지 후보도 계속 처리됩니다.",
      candidateCount: "후보 {count}개",
      noCandidates: "신뢰할 수 있는 새로운 세션 후보를 찾지 못했습니다.",
      progress: "{days}일 처리됨 · {staged}개 스테이징됨",
      processedCandidates: "세션 후보 {count}개 처리됨",
      processedDayCountOne: "{count}일 처리됨",
      processedDayCount: "{count}일 처리됨",
      complete: "{count}개 스테이징됨. 승격은 드리밍을 통해 이루어집니다",
      ...
      rollbackCounts: "일기 항목 {diary}개 및 스테이징된 항목 {staged}개 제거됨",
  ...
  custodian: {
    ...
    panel: {
      ...
      close: "OpenClaw에 질문 닫기",
      resize: "OpenClaw에 질문 크기 조절",
      dockBottom: "OpenClaw에 질문을 하단에 고정",
      dockRight: "OpenClaw에 질문을 오른쪽에 고정",
    },
    history: {
      button: "기록",
      title: "최근 변경 사항",
    ...
    nudge: {
      ...
      channelSetupBody:
        "웹 앱은 이미 사용할 수 있습니다. 다른 서비스에서 OpenClaw에 메시지를 보내려는 경우에만 채널을 추가하세요.",
  ...
  mcpPage: {
    ...
    setUpFirstServer: "첫 번째 MCP 서버 설정",
  ...
  talkPage: {
    intro: "실시간 음성 제공업체, 모델 및 화자 음성을 구성합니다.",
    voiceSection: {
      title: "실시간 음성",
      description:
        "에이전트와 연속으로 음성 대화를 나눕니다. 아래 선택 항목은 talk.realtime 설정에 반영되며, 더 아래의 전체 양식에서 나머지 모든 항목을 설정할 수 있습니다.",
    },
    status: {
      title: "상태",
      ready: "준비됨",
      notReady: "구성되지 않음",
      unavailable: "사용 불가",
      unavailableHint: "실시간 음성 사용 준비 상태를 확인하려면 Gateway에 연결하세요.",
      activeProvider: "활성 제공업체: {provider}",
      noProvider: "아직 구성된 실시간 음성 제공업체가 없습니다.",
    },
    provider: {
      title: "제공업체",
      description: "자동 선택 시 작동하는 자격 증명이 있는 첫 번째 제공업체를 선택합니다.",
      auto: "자동",
    },
    model: {
      title: "모델",
    ...
    voice: {
      title: "스피커 음성",
      description:
        "음성 응답에 사용되는 목소리입니다. GPT-Live는 통화가 시작되면 음성을 변경할 수 없습니다.",
      default: "제공업체 기본값",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live는 ChatGPT 구독을 통해 사용할 수 있습니다. “openclaw models auth login --provider openai”으로 한 번 로그인하세요. Platform API 키는 필요하지 않습니다. 브라우저 Talk에서만 사용할 수 있습니다. 위임된 작업은 실행 중에 조정할 수 있으며, 영향이 큰 작업에는 정확한 음성 확인이 필요합니다.",
      ready: "준비됨",
    },
  },
  memoryPage: {
    intro: "OpenClaw가 에이전트 메모리를 저장, 검색 및 관리하는 방식을 선택하세요.",
    tablistLabel: "메모리 섹션",
    tabs: {
      overview: "개요",
      memories: "메모리",
    ...
    overview: {
      hero: {
        awake: "메모리가 활성화되었습니다",
        waking: "메모리를 활성화하는 중…",
        hibernating: "메모리가 최대 절전 모드입니다",
        needsAttention: "메모리를 확인해야 합니다",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "이 에이전트의 메모리 엔진과 드림 사이클을 확인하는 중입니다.",
        offDescription: "설정에서 메모리 엔진을 선택하여 활성화하세요.",
        disabledDescription:
          "선택한 메모리 엔진이 비활성화되어 있습니다. 설정에서 다시 활성화하세요.",
        gatewayOffline: "Gateway가 오프라인 상태이므로 메모리 상태를 확인할 수 없습니다.",
      ...
      schedule: {
        title: "수면 일정",
        lightDescription:
          "새로운 단기 메모를 정리하고, 장기 기억을 변경하지 않으면서 가능성 있는 후보를 준비합니다.",
        remDescription:
          "최근 활동에서 나타난 주제와 반복되는 아이디어를 성찰하여 장기 기억을 변경하지 않으면서 순위를 강화합니다.",
        deepDescription:
          "준비된 후보를 평가하고, 보존할 항목을 장기 기억(MEMORY.md)으로 승격하며 꿈 일기를 작성합니다.",
        nextRun: "다음 실행 {time}",
        lastRun: "마지막 실행 {time}",
      ...
      activity: {
        ...
        phaseHitCount: "단계 신호",
        lightPhaseHitCount: "얕은 수면 단계 감지",
        remPhaseHitCount: "REM 수면 단계 감지",
      },
      health: {
        title: "엔진 상태",
        provider: "제공업체",
    ...
    memories: {
      ...
      searchButton: "검색",
      idle: "이 에이전트가 기억하는 사람, 프로젝트, 결정 또는 기타 항목을 검색하세요.",
      searching: "메모리 검색 중…",
      results: "결과 {count}개",
    ...
    dreaming: {
      intro:
        "드리밍은 모든 에이전트 워크스페이스에서 하나의 관리형 자동화로 실행되므로 이 설정은 전역으로 적용됩니다. 이 설정은 {plugin} 플러그인에서 관리합니다.",
      schedule: {
        title: "일정",
  ...
  labsPage: {
    ...
    loopDetection: {
      title: "도구 루프 감지",
      description:
        "에이전트가 더 이상 진행하지 못할 때 반복되는 도구 호출을 경고하거나 차단하는 최근 기록 기반 보호 기능을 활성화합니다.",
    },
    localModelLean: {
      title: "로컬 모델용 경량 도구",
      description:
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "활동, 비용 및 사용 추세를 확인하세요.",
    identity: {
      title: "ID",
      menuLabel: "ID 메뉴",
  ...
  skillWorkshop: {
    ...
    evaluation: {
      ...
      evaluatorVersion: "평가 도구 {version}",
      mode: "모드 {mode}",
      findings: "발견 사항",
      metrics: "측정 항목",
      fileLine: "{file}:{line}",
      errors: {
        revisionHashUnavailable: "현재 제안서의 리비전을 식별할 수 없습니다.",
        revisionChanged: "평가 중에 제안서 리비전이 변경되었습니다.",
      },
    },
    empty: {
  ...
  attention: {
    ...
    cronFailed: "자동화 {count}개 실패",
    cronOverdue: "자동화 {count}개 기한 초과",
  ...
  dreaming: {
    ...
    actions: {
      dedupeRemovedOneAndKept: "중복된 꿈 항목 {removed}개를 삭제하고 {kept}개를 유지했습니다.",
      dedupeRemovedManyAndKept: "중복된 꿈 항목 {removed}개를 삭제하고 {kept}개를 유지했습니다.",
      dedupeRemovedOne: "중복된 꿈 항목 {removed}개를 삭제했습니다.",
      dedupeRemovedMany: "중복된 꿈 항목 {removed}개를 삭제했습니다.",
      ...
      repairCompleteWithArchive: "꿈 캐시 복구 완료: {actions}. 보관 위치: {archiveDir}",
      repairComplete: "꿈 캐시 복구 완료: {actions}.",
      backfillComplete: "꿈 일기 항목 {count}개를 백필했습니다.",
      resetDiaryComplete: "백필된 꿈 일기 항목 {count}개를 제거했습니다.",
      clearReplayedComplete: "재생된 단기 항목 {count}개를 지웠습니다.",
      complete: "꿈 일기 작업이 완료되었습니다.",
      confirmRepair:
        "꿈 캐시를 복구하시겠습니까? 파생된 꿈 캐시 파일을 보관하고 깨끗한 입력 데이터로 다시 빌드합니다. 꿈 일기는 변경되지 않습니다.",
      confirmDedupe:
        "꿈 일기의 중복을 제거하시겠습니까? DREAMS.md를 다시 작성하고 완전히 동일한 일기 항목만 제거합니다.",
      archivePathCopied: "보관 경로가 복사되었습니다.",
      archivePathCopyFailed: "보관 경로를 복사할 수 없습니다.",
      updateFailed: "꿈 설정을 업데이트할 수 없습니다.",
      unsupportedPlugin: '선택한 메모리 플러그인 "{pluginId}"은(는) 꿈 설정을 지원하지 않습니다.',
      configHashMissing: "구성 해시가 없습니다. 새로 고친 후 다시 시도하세요.",
    },
    wiki: {
      ...
      counts: {
        pageOne: "페이지 {count}개",
        pages: "페이지 {count}개",
        claimRowOne: "주장 행 {count}개",
        claimRows: "주장 행 {count}개",
        openQuestionOne: "미해결 질문 {count}개",
        openQuestions: "미해결 질문 {count}개",
        contradictionOne: "모순 {count}개",
        contradictions: "모순 {count}개",
        chats: "채팅 {count}개",
        sensitive: "민감 항목 {count}개",
        signals: "신호 {count}개",
        messages: "메시지 {count}개",
        userMessages: "사용자 {count}개",
        assistantMessages: "어시스턴트 {count}개",
      },
      pageGroupSummary: "{label} · {count}",
      noPagesYet: "아직 페이지가 없습니다",
      sectionPageSummary: "{label}: {count}",
      questionCountOnPages: "{pageCount}개 페이지의 질문 {questionCount}개",
      risk: {
        needsReview: "검토 필요",
        low: "낮은 위험",
        medium: "중간 위험",
      ...
      pageNotFound: "{lookup}에 해당하는 위키 페이지를 찾을 수 없습니다.",
      previewTruncated: "이 페이지의 첫 번째 부분을 표시합니다.",
      previewTruncatedWithTotal: "이 페이지의 첫 번째 부분을 표시합니다(총 {count}줄).",
      importedClusterSummary: "{label}을 중심으로 가져온 채팅을 그룹화했습니다.",
      withheldDigestOne: "검토 대기 중인 요약 {count}개가 보류되었습니다.",
      withheldDigests: "검토 대기 중인 요약 {count}개가 보류되었습니다.",
      details: "세부 정보",
      hideDetails: "세부 정보 숨기기",
      vault: "보관함",
      fullVaultBreakdown: "전체 보관함 내역: {breakdown}.",
      selectedSection: "선택한 섹션: {summary}.",
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "추억의 길 조각 모음 중…",
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      heading: "AI 연결",
      signedInNoModels:
        "로그인했지만 이 계정에서 사용할 수 있는 모델이 없습니다. 계속하려면 다른 제공업체나 계정을 선택하세요.",
      notConfigured: "제공업체를 선택하고 OpenClaw에서 사용할 모델을 확인하세요.",
      noModels: "사용 가능한 모델 없음",
      modelRequired: "모델 필요",
      chooseProvider: "다른 제공업체 선택",
    },
    logout: {
      action: "로그아웃",
  ...
  usage: {
    ...
    heatmap: {
      title: "토큰 활동",
      subtitle: "선택한 기간의 일별 토큰 사용 강도이며, 최대 1년까지 표시됩니다.",
      cellTokens: "토큰 {tokens}개",
      less: "적음",
      more: "많음",
    },
    providerUsage: {
  ...
  chat: {
    ...
    commandResults: {
      startingNewThread: "새 스레드 시작 중...",
      resettingThread: "스레드 초기화 중...",
      stoppingCurrentRun: "현재 실행 중지 중...",
      chatHistoryCleared: "채팅 기록이 삭제되었습니다.",
      exportingThread: "스레드 내보내는 중...",
      ...
      help: {
        ...
        agentCommand: "에이전트",
        openMenu: "명령어 메뉴를 열려면 `/`를 입력하세요.",
      },
      compaction: {
        failed: "압축에 실패했습니다.",
        failedWithReason: "압축에 실패했습니다: {reason}",
        tokenSummary: " ({before} -> {after} 토큰)",
        succeeded: "컨텍스트를 성공적으로 압축했습니다",
        skipped: "압축을 건너뛰었습니다.",
        skippedWithReason: "압축을 건너뛰었습니다: {reason}",
      },
      model: {
        current: "**현재 모델:** {model}",
        ...
        set: "모델을 {model}(으)로 설정했습니다.",
        setFailed: "모델을 설정하지 못했습니다: {error}",
      },
      thinking: {
        current: "현재 사고 수준: {level}.",
        getFailed: "사고 수준을 가져오지 못했습니다: {error}",
        reset: "사고 수준을 기본값으로 재설정했습니다.",
        resetFailed: "사고 수준을 재설정하지 못했습니다: {error}",
        unrecognized: '인식할 수 없는 사고 수준 "{level}"입니다. 유효한 수준: {options}.',
        unsupported: '이 모델에서 지원하지 않는 사고 수준 "{level}"입니다. 유효한 수준: {options}.',
        set: "사고 수준을 {level}(으)로 설정했습니다.",
        setFailed: "사고 수준을 설정하지 못했습니다: {error}",
      },
      verbose: {
        current: "현재 상세 수준: {level}.",
        getFailed: "상세 수준을 가져오지 못했습니다: {error}",
        unrecognized: '인식할 수 없는 상세 수준 "{level}"입니다. 유효한 수준: off, on, full.',
      ...
      fast: {
        ...
        unrecognized:
          '인식할 수 없는 빠른 모드 "{mode}"입니다. 유효한 수준: on, off, auto, default, status.',
      ...
      usage: {
        ...
        notAvailable: "해당 없음",
        title: "스레드 사용량",
        inputTokens: "입력: {count}개 토큰",
        outputTokens: "출력: {count}개 토큰",
        totalTokens: "합계: {count}개 토큰",
      ...
      steer: {
        timeout: "방향 조정 메시지가 수락되기 전에 활성 실행이 종료되었습니다.",
        failed: "방향 조정이 실행에 도달하기 전에 실패했습니다. 다시 시도하세요.",
        usage: "사용법: `/steer <message>`",
        noActiveRun: "활성 실행이 없습니다. 대신 채팅 입력 또는 `/redirect`를 사용하세요.",
        succeeded: "방향을 조정했습니다.",
        requestFailed: "방향을 조정하지 못했습니다: {error}",
      },
      redirect: {
        timeout: "리디렉션 메시지가 수락되기 전에 활성 실행이 종료되었습니다.",
        failed: "실행에 도달하기 전에 리디렉션에 실패했습니다. 다시 시도하세요.",
        usage: "사용법: `/redirect <message>`",
        succeeded: "리디렉션되었습니다.",
        requestFailed: "리디렉션 실패: {error}",
      },
    },
    sessionSharing: {
      menu: "스레드 공유",
    ...
    markdown: {
      truncated: "… 잘림(총 {total}자 중 처음 {shown}자 표시).",
    },
    codeBlock: {
    ...
    sidebar: {
      ...
      groups: "그룹",
      coding: "코딩",
      noSessionsForAgent: "이 에이전트의 세션을 찾을 수 없습니다",
    ...
    queue: {
      ...
      states: {
        ...
        waitingForRun: "현재 실행이 끝나기를 기다리는 중",
        runningCommand: "명령 실행 중",
        waitingForReconnect: "재연결을 기다리는 중",
        needsReview: "검토 필요",
      },
    ...
    questions: {
      ...
      expired: "만료됨",
      cancelled: "취소됨",
      disconnected: "연결되지 않았습니다. 다시 연결한 후 시도하세요.",
    },
    imageLightbox: {
    ...
    messages: {
      ...
      actions: "메시지 작업",
      selectionActions: "선택 항목 작업",
      moreDetails: "자세히 보기",
      askInSideChat: "사이드 채팅에서 질문하기",
      rewind: "되감기",
      ...
      voiceNote: "음성 메모",
      duplicatesCollapsed: "연속된 동일한 메시지 {count}개가 접혔습니다",
    ...
    modelControls: {
      ...
      fastHelp: "빠른 응답은 더 빨리 완료되며 사용량 한도를 더 많이 사용할 수 있습니다.",
      speedUnsupported: "이 모델은 속도 제어를 지원하지 않습니다.",
      contextWindow: "{count} 컨텍스트",
    ...
    detailPanel: {
      ...
      fullContentOversized:
        "저장된 대화 기록 항목이 너무 커서 안전하게 반환할 수 없으므로 전체 콘텐츠를 사용할 수 없습니다.",
      fullContentNotVisible:
        "이 대화 기록 항목에는 표시 가능한 WebChat 프로젝션이 없으므로 전체 콘텐츠를 사용할 수 없습니다.",
      fullContentUnavailable: "이 대화 기록 항목의 전체 콘텐츠는 더 이상 사용할 수 없습니다.",
      copyContents: "파일 내용 복사",
      fileChanged: "파일을 불러온 후 디스크에서 변경되었습니다.",
    ...
    composer: {
      ...
      fallbackActive: "대체 모델 활성화: {model}",
      fallbackCleared: "대체 모델 해제됨: {model}",
      fallbackSelected: "선택됨: {model}",
      fallbackCurrent: "활성: {model}",
      fallbackPrevious: "이전 대체 모델: {model}",
      fallbackReason: "이유: {reason}",
      fallbackAttempts: "시도 횟수: {attempts}",
      cancelReply: "답장 취소",
      ...
      menu: {
        ...
        loadingSkills: "Skills 불러오는 중…",
        skillsLoadFailed: "Skills을 불러오지 못했습니다.",
        noSkills: "사용 가능한 Skills이 없습니다.",
        noConnectors: "구성된 MCP 서버가 없습니다.",
        depsMissing: "종속성 누락",
        skillBlocked: "이 에이전트에서는 사용할 수 없음",
        sessionTag: "세션",
        offlineBlocked: "세션 기능을 변경하려면 Gateway에 연결하세요.",
        readOnlyBlocked: "세션 기능을 변경하려면 쓰기 권한이 필요합니다.",
        adminBlocked: "커넥터를 관리하려면 관리자 액세스가 필요합니다.",
        savingBlocked: "현재 세션 기능 변경이 완료될 때까지 기다려 주세요.",
      },
      overrides: {
    ...
    voice: {
      asking: "OpenClaw에 요청하는 중...",
      connecting: "음성 입력에 연결하는 중...",
      listening: "듣는 중...",
    },
    selectors: {
  ...
  cron: {
    adminRequired: "탐색만 가능합니다. 자동화 변경에는 operator.admin 액세스 권한이 필요합니다.",
    tabs: {
      filterLabel: "자동화 상태",
      all: "전체",
      active: "활성",
