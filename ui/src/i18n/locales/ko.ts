...
export const ko: TranslationMap = {
  ...
  configForm: {
    ...
    draftRejected: "이 설정을 저장할 수 없습니다. 초안은 그대로 남아 있습니다.",
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "바닷가재 방문",
      crabVisitsOn: "가끔 들릅니다",
      crabVisitsOff: "절대 방문하지 않습니다",
      crabSounds: "바닷가재 소리",
      crabSoundsOn: "터치하면 작은 뽀글 소리",
      crabSoundsOff: "무음",
      crabdex: "Crabdex",
      crabdexSeen: "{seen}/{total} 방문함",
      crabdexFirstVisited: "{name} · 첫 방문일 {date}",
      crabdexCardFirstVisited: "처음 방문 {date}",
      crabdexCardShinySeen: "✦ {date}에 반짝이 발견",
      crabdexCardCopyLink: "링크 복사",
      crabdexOpen: "Crabdex 열기",
    },
    security: {
  ...
  subtitles: {
    ...
    crabdex: "이 브라우저를 방문한 모든 랍스터 팔레트입니다.",
