...
export const nl: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "Kreeftbezoeken",
      crabVisitsOn: "Komt af en toe langs",
      crabVisitsOff: "Komt nooit langs",
      crabSounds: "Kreeftgeluiden",
      crabSoundsOn: "Zachte blubjes bij aanraking",
      crabSoundsOff: "Stil",
      crabdex: "Crabdex",
      crabdexSeen: "{seen}/{total} bezocht",
      crabdexFirstVisited: "{name} · voor het eerst bezocht op {date}",
      crabdexCardFirstVisited: "Eerst bezocht {date}",
      crabdexCardShinySeen: "✦ Shiny gespot {date}",
      crabdexCardCopyLink: "Link kopiëren",
      crabdexOpen: "Crabdex openen",
    },
    security: {
  ...
  subtitles: {
    ...
    crabdex: "Elk crab-palet dat deze browser heeft bezocht.",
