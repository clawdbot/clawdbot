...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    showCronSessions: "Показувати сеанси автоматизації",
  ...
  agents: {
    ...
    cronPanel: {
      ...
      schedulerSubtitle: "Стан автоматизацій Gateway.",
      jobs: "Завдання",
      nextWake: "Наступне пробудження",
      agentJobsTitle: "Автоматизації агента",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Помічено блискучу картку {date}",
  ...
  subtitles: {
    ...
    tasks: "Фонові завдання: субагенти, запуски автоматизацій, CLI.",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Підготуйте надійні спогади з попередніх сеансів агента. Сновидіння переносять корисні з них у довготривалу пам’ять.",
      dateRange: "Діапазон дат сеансів",
      dateRangeHint: "Залиште будь-яку дату порожньою, щоб просканувати весь доступний діапазон.",
      from: "Від",
      to: "До",
      actions: "Заповнити за минулий період",
      ...
      candidateCount: "Кандидатів: {count}",
      noCandidates: "Нових кандидатів із надійних сеансів не знайдено.",
      progress: "Оброблено днів: {days} · підготовлено: {staged}",
      processedCandidates: "Оброблено кандидатів із сеансів: {count}",
      processedDayCountOne: "Оброблено днів: {count}",
      processedDayCount: "Оброблено днів: {count}",
      complete: "Підготовлено: {count}; перенесення відбувається через сновидіння",
      rollbackConfirmTitle: "Відкотити ретроспективне заповнення із сеансів?",
      rollbackConfirmDescription:
        "Видалити записи щоденника та підготовлені спогади, створені ретроспективним заповненням із сеансів для цього агента.",
      rollbackWarning:
        "Відстежувані курсори сеансів залишаться на місці, тому видалені записи не буде підготовлено повторно.",
      rollbackComplete: "Ретроспективне заповнення із сеансів відкочено",
      rollbackCounts: "Видалено записів щоденника: {diary}; підготовлених записів: {staged}",
      unavailable: "Ретроспективне заповнення із сеансів недоступне на цьому Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      ...
      close: "Закрити «Запитати OpenClaw»",
      resize: "Змінити розмір панелі «Запитати OpenClaw»",
      dockBottom: "Закріпити «Запитати OpenClaw» унизу",
      dockRight: "Закріпити «Запитати OpenClaw» праворуч",
    },
    history: {
      button: "Історія",
      title: "Останні зміни",
  ...
  memoryPage: {
    ...
    dreaming: {
      intro:
        "Сновидіння виконується як єдина керована автоматизація в усіх робочих просторах агентів, тому ці налаштування є глобальними. Ними керує плагін {plugin}.",
      schedule: {
        title: "Розклад",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Переглядайте активність, витрати й тенденції використання.",
    identity: {
      title: "Ідентичність",
  ...
  attention: {
    ...
    cronFailed: "Невдалі автоматизації: {count}",
    cronOverdue: "Прострочені автоматизації: {count}",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Щоденна інтенсивність використання токенів за вибраний період до одного року.",
  ...
  chat: {
    ...
    composer: {
      ...
      fallbackCurrent: "Активна модель: {model}",
      fallbackPrevious: "Попередня резервна модель: {model}",
  ...
  cron: {
    adminRequired:
      "Доступний лише перегляд. Для змін автоматизації потрібен доступ operator.admin.",
    tabs: {
