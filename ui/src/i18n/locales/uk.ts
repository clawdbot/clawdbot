...
export const uk: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "Візити омара",
      crabVisitsOn: "Час від часу заходить",
      crabVisitsOff: "Ніколи не заходить",
      crabSounds: "Звуки омара",
      crabSoundsOn: "Тихі булькання під час дотику",
      crabSoundsOff: "Без звуку",
      crabdex: "Crabdex",
      crabdexSeen: "Відвідано {seen}/{total}",
      crabdexFirstVisited: "{name} · уперше відвідано {date}",
      crabdexCardFirstVisited: "Перше відвідування {date}",
      crabdexCardShinySeen: "✦ Блискучий помічено {date}",
      crabdexCardCopyLink: "Копіювати посилання",
      crabdexOpen: "Відкрити Crabdex",
    },
    security: {
      intro:
  ...
  subtitles: {
    ...
    crabdex: "Кожна палітра лобстера, що відвідувала цей браузер.",
