...
export const id: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Permintaan pembaruan mungkin telah diterima, tetapi Gateway tidak melaporkan hasil akhir setelah menyambung kembali. Jalankan `openclaw update status` sebelum mencoba lagi.",
    failureReasons: {
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "Kunjungan crab",
      crabVisitsOn: "Mampir sesekali",
      crabVisitsOff: "Tidak pernah berkunjung",
      crabSounds: "Suara crab",
      crabSoundsOn: "Gelembung kecil saat disentuh",
      crabSoundsOff: "Senyap",
      crabdex: "Crabdex",
      crabdexSeen: "{seen}/{total} dikunjungi",
      crabdexFirstVisited: "{name} · pertama kali dikunjungi {date}",
      crabdexCardFirstVisited: "Pertama dikunjungi {date}",
      crabdexCardShinySeen: "✦ Shiny terlihat {date}",
      crabdexCardCopyLink: "Salin tautan",
      crabdexOpen: "Buka Crabdex",
    },
    security: {
  ...
  subtitles: {
    ...
    crabdex: "Setiap palet crab yang telah mengunjungi browser ini.",
  ...
  modelSetup: {
    ...
    manual: {
      ...
      selectProviderHint: "Pilih sumber kredensial ini",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Server disimpan dalam keadaan dinonaktifkan secara global, tetapi mengaktifkannya untuk sesi ini gagal: {error}",
  ...
  chat: {
    ...
    composer: {
      ...
      menu: {
        ...
        addMcpServerTitle: "Tambah server MCP",
        ...
        scopeSessionHint:
          "Server disimpan dengan status nonaktif secara global dan hanya diaktifkan untuk sesi ini.",
        scopeEverywhereHint: "Server disimpan dan diaktifkan untuk setiap sesi.",
        toolAccess: {
          label: "Akses alat",
          loading: "Memuat tools…",
          loadFailed: "Tidak dapat memuat tools.",
          noTools: "Tidak ada tools yang tersedia untuk konektor ini.",
          summary: "{enabled} dari {total} tools aktif",
          summaryOne: "{enabled} dari {total} tool aktif",
        },
