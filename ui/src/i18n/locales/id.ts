...
export const id: TranslationMap = {
  ...
  mcpApp: {
    ...
    errors: {
      ...
      sandboxTimedOut: "Sandbox MCP App kehabisan waktu",
      sandboxUnavailable: "Sandbox MCP App tidak tersedia",
      initializationTimedOut: "Inisialisasi MCP App kehabisan waktu",
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        timeout:
          "Waktu permintaan habis setelah 30 detik; server mungkin masih telah menerapkan perubahan — periksa profil sebelum mencoba lagi.",
  ...
  updates: {
    refreshRequired: "Server diperbarui — muat ulang untuk mendapatkan kemampuan penuh",
    coalescedRestart:
      "Pembaruan terinstal. Mulai ulang Gateway sedang berlangsung; status akan diperbarui setelah tersambung kembali.",
    error: "Kesalahan pembaruan: {error}",
    status: "Pembaruan {status}: {reason}. {guidance}",
    verificationFailed:
      "Pembaruan terinstal, tetapi versi yang berjalan tidak berubah — mulai ulang mungkin telah diblokir.",
    verificationFailedWithVersions:
      "Pembaruan terinstal, tetapi versi yang berjalan tidak berubah — mulai ulang mungkin telah diblokir. Diharapkan v{expectedVersion}, yang berjalan v{actualVersion}.",
    handoffTimeout:
      "Serah terima pembaruan dimulai, tetapi penyelesaiannya tidak dilaporkan setelah tersambung kembali. Jalankan `openclaw update status` untuk melihat hasil akhir.",
    outcomeUnknown:
    ...
    failureReasons: {
      ...
      noUpstream: "Tetapkan branch upstream, lalu coba lagi.",
      notGitInstall:
        "Bukan checkout git. Jalankan `openclaw update` dari CLI untuk menginstal ulang secara global.",
      notOpenclawRoot:
        "Jalankan pembaruan dari checkout OpenClaw atau gunakan jalur instalasi ulang global melalui CLI.",
      depsInstallFailed:
        "Instalasi dependensi gagal. Perbaiki kesalahan instalasi, lalu coba lagi.",
      buildFailed: "Build gagal. Perbaiki kesalahan build, lalu coba lagi.",
      buildDirty:
        "Build revisi yang dipilih mengubah file checkout. Coba lagi dengan revisi yang menyertakan artefak hasil pembuatannya.",
      uiBuildFailed:
        "Pembuatan ulang Control UI gagal. Perbaiki kesalahan build UI lalu coba lagi.",
      globalInstallFailed:
        "Instalasi paket global tidak dapat diverifikasi di disk. Coba lagi atau instal ulang dari CLI.",
      restartDisabled:
        "Pembaruan tidak diterapkan karena mulai ulang Gateway dinonaktifkan. Aktifkan mulai ulang di config, lalu coba lagi.",
      restartUnavailable:
        "Instalasi global ini tidak dapat diganti dengan aman saat mulai ulang dinonaktifkan dan tidak ada supervisor.",
      restartUnhealthy:
        "Proses pengganti tidak pernah mencapai kondisi sehat. Proses sebelumnya tetap berjalan agar Anda dapat melakukan pemulihan.",
      managedServiceHandoffAlreadyRunning:
        "Pembaruan terkelola lain sedang berjalan. Tunggu hingga selesai, lalu muat ulang status pembaruan.",
      doctorFailed:
        "Perbaikan Doctor gagal. Jalankan `openclaw doctor --non-interactive` lalu coba lagi.",
      default:
        "Lihat log Gateway untuk mengetahui kegagalan yang tepat, lalu coba lagi setelah penyebabnya diperbaiki.",
    },
    postRestart: {
      restartUnhealthy:
        "Proses pengganti tidak pernah mencapai kondisi sehat dan proses sebelumnya tetap berjalan.",
      default: "Periksa log Gateway untuk mengetahui kegagalan proses pengganti.",
    },
  },
  nodes: {
    pairing: {
  ...
  sessionsView: {
    ...
    showCronSessions: "Tampilkan sesi otomatisasi",
  ...
  agents: {
    ...
    cronPanel: {
      ...
      schedulerSubtitle: "Status otomatisasi Gateway.",
      jobs: "Tugas",
      nextWake: "Bangun berikutnya",
      agentJobsTitle: "Otomatisasi Agen",
  ...
  configForm: {
    redactedPlaceholder: "[disamarkan - klik tampilkan untuk melihat]",
  ...
  terminal: {
    ...
    uploadTooLarge: "File melebihi batas unggahan terminal sebesar 16 MiB: {file}",
    uploadUnsafeCmdPath:
      "Tidak dapat menyisipkan dengan aman jalur unggahan yang berisi % atau ! ke dalam cmd.exe",
    uploadUnsupportedShell:
      "Tidak dapat menyisipkan dengan aman jalur unggahan ke dalam shell yang tidak didukung: {shell}",
  },
  browser: {
    title: "Browser",
    ...
    errors: {
      ...
      screenshotPathMissing: "Tangkapan layar browser tidak menghasilkan jalur media.",
      screenshotFetchTimedOut: "Waktu pengambilan tangkapan layar habis.",
  ...
  subtitles: {
    ...
    tasks: "Tugas latar belakang: subagen, eksekusi otomatisasi, CLI.",
    ...
    automation: "Perintah, hook, otomatisasi, dan plugin.",
    mcp: "Server MCP, autentikasi, alat, dan diagnostik.",
    memory: "Engine memori, backend, pencarian, dan dreaming.",
    talk: "Suara waktu nyata: penyedia, model, dan suara pembicara.",
  ...
  modelSetup: {
    ...
    required: {
      ...
      body: "OpenClaw tidak dapat menemukan penyedia dan model yang dikonfigurasi untuk agen ini. Tambahkan sebelum memulai percakapan.",
      action: "Konfigurasikan penyedia",
    },
    connectionFailure: {
      title: "OpenClaw tidak dapat menggunakan AI yang Anda konfigurasi",
      body: "Agen ini telah memilih penyedia dan model, tetapi koneksi gagal. Periksa login penyedia atau kunci API, akses model, dan status layanan, lalu coba lagi.",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Siapkan memori tepercaya dari sesi agen sebelumnya. Proses bermimpi memasukkan memori yang berguna ke dalam memori jangka panjang.",
      dateRange: "Rentang tanggal sesi",
      dateRangeHint:
        "Biarkan salah satu tanggal kosong untuk memindai seluruh rentang yang tersedia.",
      from: "Dari",
      to: "Hingga",
      actions: "Isi ulang",
      preview: "Pratinjau",
      ...
      previewTruncated:
        "Pratinjau ini menampilkan batch terbatas pertama. Penerapan berlanjut ke kandidat yang tersisa.",
      candidateCount: "{count} kandidat",
      noCandidates: "Tidak ditemukan kandidat sesi tepercaya baru.",
      progress: "Memproses {days} hari · {staged} ditahapkan",
      ...
      complete: "{count} ditahapkan; promosi dilakukan melalui dreaming",
      rollbackConfirmTitle: "Urungkan pengisian kembali sesi?",
      rollbackConfirmDescription:
        "Hapus entri diari dan memori yang ditahapkan yang dibuat oleh pengisian kembali sesi untuk agen ini.",
      rollbackWarning:
        "Kursor sesi yang dilacak tetap dipertahankan, sehingga entri yang dihapus tidak akan ditahapkan lagi.",
      rollbackComplete: "Pengisian kembali sesi diurungkan",
      rollbackCounts: "{diary} entri diari dan {staged} entri yang ditahapkan dihapus",
      unavailable: "Pengisian kembali sesi tidak tersedia di Gateway ini.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      ...
      close: "Tutup Tanya OpenClaw",
      resize: "Ubah ukuran Tanya OpenClaw",
      dockBottom: "Tambatkan Tanya OpenClaw di bawah",
      dockRight: "Tambatkan Tanya OpenClaw di kanan",
    },
    history: {
      button: "Riwayat",
    ...
    nudge: {
      ...
      channelSetupTitle: "Akses OpenClaw di luar aplikasi ini",
      channelSetupBody:
        "Aplikasi web sudah dapat digunakan. Tambahkan saluran hanya jika Anda ingin mengirim pesan ke OpenClaw dari layanan lain.",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Server disimpan dalam keadaan dinonaktifkan secara global, tetapi gagal diaktifkan untuk sesi ini: {error}",
  ...
  mcpPage: {
    intro: "Hubungkan dan kelola server MCP yang menyediakan alat untuk OpenClaw.",
  ...
  talkPage: {
    intro: "Konfigurasikan penyedia suara waktu nyata, model, dan suara pembicara.",
    voiceSection: {
      title: "Suara waktu nyata",
      description:
        "Percakapan suara berkelanjutan dengan agen Anda. Pemilih di bawah ini mengubah pengaturan talk.realtime; formulir lengkap di bagian bawah mencakup semua pengaturan lainnya.",
    },
    status: {
      title: "Status",
      ready: "Siap",
      ...
      unavailable: "Tidak tersedia",
      unavailableHint: "Hubungkan ke Gateway untuk memeriksa kesiapan suara waktu nyata.",
      activeProvider: "Penyedia aktif: {provider}",
      noProvider: "Belum ada penyedia suara waktu nyata yang dikonfigurasi.",
    },
    provider: {
      title: "Penyedia",
      description: "Otomatis memilih penyedia pertama dengan kredensial yang berfungsi.",
      auto: "Otomatis",
    },
    model: {
      title: "Model",
      description: "Model suara waktu nyata untuk sesi Talk di browser.",
    ...
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live berfungsi dengan langganan ChatGPT: masuk sekali dengan “openclaw models auth login --provider openai”. Tidak memerlukan kunci Platform API. Hanya untuk Talk di browser. Pekerjaan yang didelegasikan dapat diarahkan saat berjalan dan memerlukan konfirmasi lisan yang persis untuk tindakan berdampak besar.",
      ready: "Siap",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        awake: "Memori aktif",
        waking: "Mengaktifkan memori…",
        hibernating: "Memori sedang berhibernasi",
        ...
        gatewayOffline: "Gateway sedang offline, sehingga status memori tidak tersedia.",
      ...
      schedule: {
        title: "Jadwal tidur",
        lightDescription:
          "Mengurutkan catatan jangka pendek terbaru dan menyiapkan kandidat yang menjanjikan tanpa mengubah memori jangka panjang.",
        remDescription:
          "Merefleksikan tema dan ide berulang dari aktivitas terbaru untuk memperkuat pemeringkatan tanpa mengubah memori jangka panjang.",
        deepDescription:
          "Memberi skor pada kandidat yang telah disiapkan, memasukkan kandidat terpilih ke memori jangka panjang (MEMORY.md), dan menulis buku harian mimpi.",
        nextRun: "berikutnya {time}",
        lastRun: "terakhir {time}",
        notScheduled: "Tidak dijadwalkan",
        learnMore: "Cara kerja proses bermimpi",
        openDocs: "Buka panduan bermimpi",
      },
      activity: {
        title: "Aktivitas",
        promotedToday: "Dipromosikan hari ini",
        promotedTotal: "Total dipromosikan",
        shortTermCount: "Entri jangka pendek yang tertunda",
        phaseHitCount: "Sinyal fase",
        lightPhaseHitCount: "Kecocokan fase ringan",
        remPhaseHitCount: "Kecocokan fase REM",
      },
      health: {
    ...
    memories: {
      ...
      idle: "Cari orang, proyek, keputusan, atau hal lain yang diingat agen ini.",
      ...
      sourceMemory: "memori",
      sourceSessions: "sesi",
      fileLoading: "Memuat file memori lengkap…",
      fileError: "Tidak dapat memuat file memori ini: {message}",
      fileUnsupported: "File memori ini tidak dapat ditampilkan sebagai teks.",
    },
    engine: {
      title: "Engine",
      description:
    ...
    dreaming: {
      intro:
        "Dreaming berjalan sebagai satu otomatisasi terkelola di seluruh ruang kerja agen, sehingga pengaturan ini bersifat global. Pengaturan ini dikelola oleh plugin {plugin}.",
      schedule: {
        title: "Jadwal",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Aktifkan perlindungan riwayat bergulir yang memperingatkan atau memblokir pemanggilan alat berulang saat agen berhenti membuat kemajuan.",
    },
    localModelLean: {
  ...
  attention: {
    ...
    cronFailed: "{count} otomatisasi gagal",
    cronOverdue: "{count} otomatisasi terlambat",
  ...
  dreaming: {
    ...
    actions: {
      dedupeRemovedOneAndKept:
        "Menghapus {removed} entri mimpi duplikat dan mempertahankan {kept}.",
      ...
      repairArchivedIngestionState: "status penyerapan yang diarsipkan",
      repairArchivedDreamDiary: "diari mimpi yang diarsipkan",
      ...
      backfillComplete: "Berhasil mengisi ulang {count} entri diari mimpi.",
      resetDiaryComplete: "Menghapus {count} entri diari mimpi yang diisi ulang.",
      clearReplayedComplete: "Menghapus {count} entri jangka pendek yang diputar ulang.",
      complete: "Tindakan diari mimpi selesai.",
      confirmRepair:
        "Perbaiki Cache Mimpi? Tindakan ini mengarsipkan file cache mimpi turunan dan menyusunnya kembali dari input yang bersih. Diari mimpi Anda tidak akan diubah.",
      confirmDedupe:
        "Hapus Duplikat Diari Mimpi? Tindakan ini menulis ulang DREAMS.md dan hanya menghapus entri diari yang sama persis.",
      archivePathCopied: "Jalur arsip disalin.",
      archivePathCopyFailed: "Tidak dapat menyalin jalur arsip.",
      updateFailed: "Tidak dapat memperbarui pengaturan mimpi.",
      unsupportedPlugin:
        'Plugin memori yang dipilih, "{pluginId}", tidak mendukung pengaturan mimpi.',
      configHashMissing: "Hash konfigurasi tidak ditemukan; muat ulang dan coba lagi.",
    },
    wiki: {
      ...
      emptyWiki: "Wiki memori belum diisi",
      emptyWikiHint:
      ...
      pageNotFound: "Tidak ditemukan halaman wiki untuk {lookup}.",
      previewTruncated: "Menampilkan bagian pertama halaman ini.",
      previewTruncatedWithTotal: "Menampilkan bagian pertama halaman ini (total {count} baris).",
      importedClusterSummary: "Chat yang diimpor dikelompokkan berdasarkan {label}.",
      withheldDigestOne: "{count} ringkasan ditahan untuk menunggu peninjauan.",
      withheldDigests: "{count} ringkasan ditahan untuk menunggu peninjauan.",
      details: "Detail",
      hideDetails: "Sembunyikan detail",
      vault: "Brankas",
      fullVaultBreakdown: "Rincian lengkap brankas: {breakdown}.",
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "mendefragmentasi lorong kenangan…",
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      heading: "Hubungkan AI Anda",
      signedInNoModels:
        "Anda sudah masuk, tetapi akun ini tidak menyediakan model yang dapat digunakan. Pilih penyedia atau akun lain untuk melanjutkan.",
  ...
  chat: {
    ...
    commandResults: {
      startingNewThread: "Memulai utas baru...",
      resettingThread: "Mengatur ulang utas...",
      stoppingCurrentRun: "Menghentikan proses saat ini...",
      chatHistoryCleared: "Riwayat obrolan telah dihapus.",
      exportingThread: "Mengekspor utas...",
      unknownCommand: "Perintah tidak dikenal: `{command}`",
      options: "Opsi: {options}.",
      sessionUnavailable: "Kemampuan sesi tidak tersedia",
      help: {
      ...
      thinking: {
        current: "Tingkat penalaran saat ini: {level}.",
        getFailed: "Gagal mendapatkan tingkat penalaran: {error}",
        reset: "Tingkat penalaran diatur ulang ke default.",
        resetFailed: "Gagal mengatur ulang tingkat penalaran: {error}",
        unrecognized: 'Tingkat penalaran "{level}" tidak dikenali. Tingkat yang valid: {options}.',
        unsupported:
          'Tingkat penalaran "{level}" tidak didukung untuk model ini. Tingkat yang valid: {options}.',
        set: "Tingkat penalaran diatur ke {level}.",
        setFailed: "Gagal mengatur tingkat penalaran: {error}",
      },
      verbose: {
        current: "Tingkat verbositas saat ini: {level}.",
        getFailed: "Gagal mendapatkan tingkat verbositas: {error}",
        unrecognized:
          'Tingkat verbositas "{level}" tidak dikenali. Tingkat yang valid: off, on, full.',
        set: "Mode verbose diatur ke {level}.",
        setFailed: "Gagal mengatur mode verbose: {error}",
      },
      fast: {
        autoValue: "otomatis ({seconds} dtk)",
        on: "aktif",
        off: "nonaktif",
        sourceSession: " (sesi)",
        sourceAgent: " (default: agen)",
        ...
        reset: "Mode cepat direset ke default.",
        resetFailed: "Gagal mereset mode cepat: {error}",
        unrecognized:
          'Mode cepat "{mode}" tidak dikenali. Tingkat yang valid: on, off, auto, default, status.',
        setAuto: "Mode cepat diatur ke otomatis.",
        enabled: "Mode cepat diaktifkan.",
        disabled: "Mode cepat dinonaktifkan.",
        setFailed: "Gagal mengatur mode cepat: {error}",
      },
      usage: {
        noActiveThread: "Tidak ada utas aktif.",
        notAvailable: "t/a",
        title: "Penggunaan Utas",
      ...
      agents: {
        none: "Tidak ada agen yang dikonfigurasi.",
        title: "**Agen** ({count})",
        default: "default",
        runtime: " · runtime {runtime}",
        failed: "Gagal menampilkan daftar agen: {error}",
      },
      steer: {
        timeout: "Proses aktif berakhir sebelum pesan pengarahan diterima.",
        failed: "Pengarahan gagal sebelum mencapai proses; coba lagi.",
        usage: "Penggunaan: `/steer <message>`",
        noActiveRun:
          "Tidak ada proses aktif. Gunakan input obrolan atau `/redirect` sebagai gantinya.",
        succeeded: "Berhasil diarahkan.",
        requestFailed: "Gagal mengarahkan: {error}",
      },
      redirect: {
        timeout: "Proses aktif berakhir sebelum pesan pengalihan diterima.",
        failed: "Pengalihan gagal sebelum mencapai proses; coba lagi.",
        usage: "Penggunaan: `/redirect <message>`",
        succeeded: "Dialihkan.",
        requestFailed: "Gagal mengalihkan: {error}",
      },
    },
    sessionSharing: {
      menu: "Berbagi thread",
    ...
    markdown: {
      truncated: "… dipotong ({total} karakter, menampilkan {shown} karakter pertama).",
    },
    codeBlock: {
    ...
    sidebar: {
      ...
      groups: "Grup",
      coding: "Coding",
      noSessionsForAgent: "Tidak ditemukan sesi untuk agen ini",
      ...
      catalogDiscoveryHelp:
        "{error}. Konfigurasikan penemuan utas native di Pengaturan > Otomatisasi > Plugin.",
    },
    welcome: {
    ...
    queue: {
      ...
      states: {
        ...
        applyingSettings: "Menerapkan pengaturan chat",
        waitingForRun: "Menunggu proses saat ini",
        runningCommand: "Menjalankan perintah",
        waitingForReconnect: "Menunggu koneksi ulang",
        needsReview: "Perlu ditinjau",
      },
    ...
    goals: {
      ...
      clear: "Hapus tujuan",
      showDetails: "Tampilkan detail tujuan",
      hideDetails: "Sembunyikan detail tujuan",
    },
    questions: {
      ...
      expired: "Kedaluwarsa",
      cancelled: "Dibatalkan",
      disconnected: "Tidak terhubung. Coba lagi setelah terhubung kembali.",
    },
    imageLightbox: {
    ...
    mediaPlayer: {
      ...
      videoUnavailable: "Format ini tidak dapat diputar — unduh sebagai gantinya.",
    },
    modelControls: {
      current: "Saat ini",
      default: "Default",
      ...
      contextWindow: "{count} konteks",
      providerModels: "Model {provider}",
      resetReasoning: "Atur ulang ke default ({level})",
      useDefaultReasoning: "Gunakan penalaran default ({level})",
    ...
    detailPanel: {
      ...
      fullContentOversized:
        "Konten lengkap tidak tersedia karena entri transkrip yang disimpan terlalu besar untuk dikembalikan dengan aman.",
      ...
      fileChanged: "File telah berubah di disk sejak dimuat.",
      renderPreview: "Pratinjau hasil render",
      ...
      overwriteLoadFailed: "Gagal memuat file terbaru sebelum menimpanya.",
    ...
    composer: {
      ...
      compactingContext: "Memadatkan konteks...",
      compacting: "Sedang memadatkan",
      compact: "Padatkan",
      contextCompacted: "Konteks dipadatkan",
      fallbackActive: "Fallback aktif: {model}",
      fallbackCleared: "Fallback dihapus: {model}",
      ...
      menu: {
        ...
        addMcpServer: "Tambahkan server MCP…",
        addMcpServerTitle: "Tambahkan server MCP",
        addMcpServerDescription: "Konfigurasikan server dan pilih tempat server diaktifkan.",
        scopeLabel: "Ketersediaan",
        scopeSession: "Sesi ini",
        scopeEverywhere: "Di mana saja",
        scopeSessionHint:
          "Server disimpan secara global dalam keadaan dinonaktifkan dan hanya diaktifkan untuk sesi ini.",
        ...
        depsMissing: "dependensi tidak tersedia",
        skillBlocked: "tidak tersedia untuk agen ini",
        sessionTag: "sesi",
        offlineBlocked: "Hubungkan ke Gateway untuk mengubah kemampuan sesi.",
        readOnlyBlocked: "Akses tulis diperlukan untuk mengubah kemampuan sesi.",
        adminBlocked: "Akses admin diperlukan untuk mengelola konektor.",
        savingBlocked: "Tunggu hingga perubahan kapabilitas sesi saat ini selesai.",
      },
      overrides: {
        count: "{count} penggantian sesi",
        countOne: "{count} penggantian sesi",
        clear: "Hapus penggantian sesi",
      },
      contextUsage: {
    ...
    voice: {
      asking: "Menanyakan kepada OpenClaw...",
  ...
  cron: {
    adminRequired: "Hanya dapat menjelajah. Perubahan otomatisasi memerlukan akses operator.admin.",
    tabs: {
