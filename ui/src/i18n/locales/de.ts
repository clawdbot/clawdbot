...
export const de: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "OpenCrustacean wurde im Hintergrund aktualisiert. Laden Sie die Seite neu, um das neueste Panel zu erhalten.",
  ...
  updates: {
    ...
    failureReasons: {
      ...
      notOpenclawRoot:
        "Führen Sie das Update aus einem OpenCrustacean-Checkout aus oder verwenden Sie den CLI-Pfad zur globalen Neuinstallation.",
      depsInstallFailed:
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "QR-Code für die Kopplung mit OpenCrustacean mobile",
      ...
      review: "Überprüfung",
      waiting: "Offizielle mobile OpenCrustacean-Apps verbinden sich nach dem Scannen automatisch.",
  ...
  worktrees: {
    ...
    subtitle: "Isolierte Repository-Checkouts im Besitz von OpenCrustacean.",
    cleanNow: "Jetzt bereinigen",
    cleanupTitle: "Bereinigung",
    cleanupSubtitle:
      "OpenCrustacean entfernt regelmäßig alte Worktrees, um Speicherplatz freizugeben. Legen Sie fest, wie aggressiv die Bereinigung durchgeführt wird.",
  ...
  newSession: {
    ...
    cloudRequiresOpenCrustaceanRuntime:
      "Cloud-Worker benötigen die OpenCrustacean-Laufzeit; {runtime} ist ausgewählt.",
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "Hummerbesuche",
      crabVisitsOn: "Schaut gelegentlich vorbei",
      crabVisitsOff: "Besucht nie",
      crabSounds: "Hummergeräusche",
      crabSoundsOn: "Leise Blubbergeräusche bei Berührung",
      crabSoundsOff: "Stumm",
      crabdex: "Crabdex",
      crabdexSeen: "{seen}/{total} besucht",
      crabdexFirstVisited: "{name} · zuerst besucht am {date}",
      crabdexCardFirstVisited: "Erstmals besucht {date}",
      crabdexCardShinySeen: "✦ Shiny entdeckt {date}",
      crabdexCardCopyLink: "Link kopieren",
      crabdexOpen: "Crabdex öffnen",
    },
    security: {
      intro:
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint:
        "Benachrichtigungen werden von der OpenCrustacean-App auf diesem Mac nativ angezeigt.",
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenCrustacean in macOS deaktiviert. Erlaube sie unter Systemeinstellungen > Mitteilungen.",
    },
    appearance: {
  ...
  nav: {
    ...
    askOpenCrustacean: "OpenCrustacean fragen",
  ...
  subtitles: {
    ...
    crabdex: "Jede Crab-Palette, die diesen Browser besucht hat.",
  ...
  modelSetup: {
    ...
    intro:
      "OpenCrustacean verwendet bereits vorhandenen KI-Zugriff – eine CLI-Anmeldung, einen API-Schlüssel oder eine Anbieteranmeldung.",
    required: {
      title: "Kein KI-Anbieter konfiguriert",
      body: "OpenCrustacean konnte für diesen Agenten keinen konfigurierten Anbieter und kein Modell finden. Fügen Sie eines hinzu, bevor Sie eine Konversation starten.",
      action: "Anbieter konfigurieren",
    },
    connectionFailure: {
      title: "OpenCrustacean konnte Ihre konfigurierte KI nicht verwenden",
    ...
    access: {
      ...
      gatewayTooOld: "Der Gateway verwendet eine ältere OpenCrustacean-Version",
    },
    candidates: {
    ...
    manual: {
      ...
      verifyHint:
        "OpenCrustacean verifiziert eine echte Modellantwort, bevor die Verbindung als bereit markiert wird.",
      required: "Wählen Sie einen Anbieter aus und geben Sie einen API-Schlüssel oder Token ein.",
    },
    success: {
      title: "Ihre KI ist bereit",
      body: "OpenCrustacean hat eine echte Antwort von {modelRef} erhalten. Sie können jetzt mit dem Chatten beginnen.",
  ...
  memoryImport: {
    ...
    confirmBackup:
      "OpenCrustacean erstellt vor dem Kopieren des Memory eine verifizierte Sicherung.",
    ...
    subtitle:
      "Prüfen Sie das konsolidierte Memory von Codex und das automatische Memory von Claude Code, bevor Sie es in OpenCrustacean kopieren.",
    agent: "Zielagent",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "OpenCrustacean hat Speicher anderer Programmierassistenten gefunden. Möchten Sie ihn in den Arbeitsbereich Ihres Agenten importieren?",
      ...
      doneBody:
        "{migrated} migriert, {skipped} übersprungen. Sie können mit der Einrichtung von OpenCrustacean fortfahren.",
    },
  },
  custodian: {
    ...
    placeholder: "Nachricht an OpenCrustacean …",
    sensitivePlaceholder: "Sensiblen Wert eingeben …",
    sensitiveReply: "Sensible Antwort gesendet",
    send: "Senden",
    thinking: "OpenCrustacean denkt nach",
    earlier: "Früher",
    requestFailed: "OpenCrustacean konnte nicht antworten. Versuche es erneut.",
    connectionChanged:
      "Die Gateway-Verbindung hat sich geändert. Wiederhole, um diese Einrichtung fortzusetzen.",
    sessionRestarted:
      "{error} OpenCrustacean hat eine neue Sitzung gestartet; frühere Nachrichten bleiben als Kontext erhalten.",
    unsupportedGateway:
      "Aktualisiere das Gateway, um die Einrichtung mit OpenCrustacean fortzusetzen.",
    panel: {
      title: "OpenCrustacean",
      toggle: "OpenCrustacean fragen",
      close: "Ask OpenCrustacean schließen",
      resize: "Ask OpenCrustacean skalieren",
      dockBottom: "Ask OpenCrustacean unten andocken",
      dockRight: "Ask OpenCrustacean rechts andocken",
    },
    history: {
      button: "Verlauf",
      ...
      requestFailed: "OpenCrustacean konnte den Änderungsverlauf nicht laden.",
      loadMore: "Mehr laden",
    ...
    nudge: {
      ...
      channelSetupTitle: "OpenCrustacean außerhalb dieser App erreichen",
      channelSetupBody:
        "Die Web-App funktioniert bereits. Füge nur dann einen Kanal hinzu, wenn du OpenCrustacean von einem anderen Dienst aus Nachrichten senden möchtest.",
  ...
  mcpPage: {
    intro: "MCP-Server verbinden und verwalten, die OpenCrustacean Tools bereitstellen.",
  ...
  memoryPage: {
    intro: "Lege fest, wie OpenCrustacean den Agenten-Speicher ablegt, durchsucht und pflegt.",
    ...
    backend: {
      ...
      builtin: "Integriert",
      qmd: "QMD",
      builtinHint: "Speicherdateien werden von OpenCrustacean selbst indexiert und durchsucht.",
  ...
  pluginsPage: {
    ...
    noInstalledBody:
      "Entdecke ein empfohlenes Plugin oder durchsuche ClawHub, um OpenCrustacean zu erweitern.",
    ...
    optionalCapability: "Optionale OpenCrustacean-Funktion.",
    enabled: "Aktiviert",
    disabled: "Deaktiviert",
    available: "Verfügbar",
  ...
  aboutPage: {
    ...
    license: "© 2026 OpenCrustacean Foundation — MIT-Lizenz.",
  ...
  appsPage: {
    heroTitle: "Nehmen Sie OpenCrustacean überallhin mit",
    heroTagline:
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatten, sprechen, Aktionen genehmigen und aus iOS in OpenCrustacean teilen.",
      },
      android: {
        title: "Android",
        desc: "Dein Android-Telefon als vollständiger OpenCrustacean-Knoten – Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Der Android-Begleiter erweitert OpenCrustacean auf deine Uhr.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Die Windows-Begleit-App verbindet Ihren PC als OpenCrustacean-Node.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Lassen Sie OpenCrustacean Ihr vorhandenes Chrome steuern – Tabs, Seiten und Formulare.",
      },
      plugins: {
        title: "Plugins & ClawHub",
        desc: "Erweitern Sie OpenCrustacean mit Kanälen, Tools und Skills aus der Community.",
      },
    },
  },
  presence: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "OpenCrustacean prüft Korrekturen und umfangreiche abgeschlossene Durchläufe und erstellt anschließend Skill-Vorschläge für dieses Board. Dabei werden zusätzliche Hintergrund-Tokens verbraucht und die Entwürfe erscheinen als ausstehende Vorschläge.",
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      notConfigured:
        "Wähle einen Anbieter und überprüfe das Modell, das OpenCrustacean verwenden wird.",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Starte das Gateway nach dem Aktualisieren von OpenCrustacean neu, damit es das aktuelle Protokoll bereitstellt.",
      },
      network: {
  ...
  chat: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenCrustacean hat deine lokalen Versionen beibehalten und die anderen Cloud-Änderungen übernommen. Prüfe das bereitgestellte Ergebnis oder übernimm dessen Version für einen konfliktbehafteten Pfad.",
      ...
      commandsUnavailable:
        "Dieser Dateiname enthält Terminal-Steuerzeichen, sodass OpenCrustacean dafür keinen kopierbaren Shell-Befehl erstellt. Überprüfen Sie die bereitgestellte Referenz direkt und geben Sie den Pfad sorgfältig manuell ein.",
    ...
    voice: {
      asking: "OpenCrustacean wird gefragt...",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Beschreibe, was OpenCrustacean tun soll und wann — es läuft nach Zeitplan.",
    ...
    detail: {
      ...
      newSubtitle:
        "Beschreibe, was OpenCrustacean tun soll, und wähle dann, wann es ausgeführt wird.",
    ...
    form: {
      ...
      promptPlaceholder: "Beschreiben, was OpenCrustacean tun soll...",
      repeat: "Wiederholen",
