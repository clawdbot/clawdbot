...
export const tr: TranslationMap = {
  ...
  sessionsView: {
    ...
    showCronSessions: "Otomasyon oturumlarını göster",
  ...
  agents: {
    ...
    cronPanel: {
      ...
      schedulerSubtitle: "Gateway otomasyonlarının durumu.",
      jobs: "İşler",
      nextWake: "Sonraki uyandırma",
      agentJobsTitle: "Aracı Otomasyonları",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Parlak olan {date} tarihinde görüldü",
  ...
  subtitles: {
    ...
    tasks: "Arka plan görevleri: alt aracılar, otomasyon çalıştırmaları, CLI.",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Önceki aracı oturumlarındaki güvenilir anıları hazırlayın. Rüya görme, yararlı olanları uzun süreli belleğe aktarır.",
      dateRange: "Oturum tarih aralığı",
      dateRangeHint:
        "Kullanılabilir aralığın tamamını taramak için tarihlerden birini boş bırakın.",
      from: "Başlangıç",
      to: "Bitiş",
      actions: "Geçmişi doldur",
      preview: "Önizleme",
      previewing: "Önizleniyor…",
      apply: "Uygula",
      applying: "Uygulanıyor…",
      rollback: "Geri al",
      previewSummary: "{days} gün içinde {candidates} aday",
      previewTruncated:
        "Bu önizleme, sınırlandırılmış ilk grubu gösterir. Uygulama, kalan adaylarla devam eder.",
      ...
      complete: "{count} hazırlandı; yükseltme, rüya görme yoluyla gerçekleşir",
      rollbackConfirmTitle: "Oturum geçmişe dönük doldurma işlemi geri alınsın mı?",
      rollbackConfirmDescription:
        "Bu aracı için oturum geçmişe dönük doldurma işlemiyle oluşturulan günlük kayıtlarını ve hazırlanmış anıları kaldırın.",
      rollbackWarning:
        "İzlenen oturum imleçleri yerinde kalır; bu nedenle kaldırılan kayıtlar yeniden hazırlanmaz.",
      rollbackComplete: "Oturum geçmişe dönük doldurma işlemi geri alındı",
      rollbackCounts: "{diary} günlük kaydı ve {staged} hazırlanmış kayıt kaldırıldı",
      unavailable: "Oturum geçmişe dönük doldurma özelliği bu Gateway üzerinde kullanılamıyor.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      ...
      close: "OpenClaw'a Sor'u kapat",
      resize: "OpenClaw'a Sor'u yeniden boyutlandır",
      dockBottom: "OpenClaw'a Sor'u alta sabitle",
      dockRight: "OpenClaw'a Sor'u sağa sabitle",
    },
    history: {
      button: "Geçmiş",
  ...
  memoryPage: {
    ...
    dreaming: {
      intro:
        "Rüya görme, tüm aracı çalışma alanlarında tek bir yönetilen otomasyon olarak çalışır; dolayısıyla bu ayarlar geneldir. Bu ayarlar {plugin} eklentisi tarafından yönetilir.",
      schedule: {
        title: "Zamanlama",
  ...
  attention: {
    ...
    cronFailed: "{count} otomasyon başarısız oldu",
    cronOverdue: "{count} otomasyonun süresi geçti",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Seçilen aralık için bir yıla kadar günlük token yoğunluğu.",
  ...
  chat: {
    ...
    messages: {
      ...
      message: "mesaj",
      currentMessage: "geçerli mesaj",
      actions: "Mesaj eylemleri",
      selectionActions: "Seçim eylemleri",
    ...
    composer: {
      ...
      fallbackPrevious: "Önceki yedek model: {model}",
      fallbackReason: "Neden: {reason}",
      fallbackAttempts: "Deneme sayısı: {attempts}",
  ...
  cron: {
    adminRequired:
      "Yalnızca göz atabilirsiniz. Otomasyon değişiklikleri operator.admin erişimi gerektirir.",
    tabs: {
