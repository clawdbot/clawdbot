...
export const tr: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Güncelleme isteği kabul edilmiş olabilir, ancak Gateway yeniden bağlandıktan sonra kesin bir sonuç bildirmedi. Yeniden denemeden önce `openclaw update status` komutunu çalıştırın.",
    failureReasons: {
  ...
  configForm: {
    ...
    invalidJson: "Bu alandan ayrılmadan önce geçerli JSON girin.",
    invalidString: "Bu ayarın kısıtlamalarına uygun bir değer girin.",
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "Istakoz ziyaretleri",
      crabVisitsOn: "Ara sıra uğrar",
      crabVisitsOff: "Asla ziyaret etmez",
      crabSounds: "Istakoz sesleri",
      crabSoundsOn: "Dokunulduğunda küçük blub sesleri",
      crabSoundsOff: "Sessiz",
      crabdex: "Crabdex",
      crabdexSeen: "{seen}/{total} ziyaret edildi",
      crabdexFirstVisited: "{name} · ilk ziyaret {date}",
      crabdexCardFirstVisited: "İlk ziyaret {date}",
      crabdexCardShinySeen: "✦ Parlak {date} tarihinde görüldü",
      crabdexCardCopyLink: "Bağlantıyı kopyala",
      crabdexOpen: "Crabdex'i aç",
    },
    security: {
      intro:
  ...
  subtitles: {
    ...
    crabdex: "Bu tarayıcıyı ziyaret eden her crab paleti.",
