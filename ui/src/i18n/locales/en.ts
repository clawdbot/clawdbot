...
export const en: TranslationMap = {
  ...
  workboard: {
    ...
    detailProof: "Proof",
    detailProofLatest: "Latest {loaded} of {total} proof records",
    ...
    searchPlaceholder: "Search cards and loaded proof",
    searchProofScopeHint: "Proof search covers only the recent records loaded in this view.",
