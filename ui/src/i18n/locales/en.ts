  ...
  chat: {
    ...
    composer: {
      ...
      contextUsage: {
        ...
        categoryTools: "Tool definitions",
        categoryRules: "Rules",
        categorySkills: "Skills",
        categoryMcpTools: "MCP & dynamic tools",
        categorySummaries: "Summarized conversation",
        categoryConversation: "Conversation",
        localEstimateNote: "Local tokenizer estimate (provider did not report full context usage).",
      },
