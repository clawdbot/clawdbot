...
export const en: TranslationMap & {
  ...
  profilePage: {
    ...
    modelAccounts: {
      ...
      statusTimedOut: "Sign-in has not finished. Check its status or cancel and connect again.",
      notices: {
      ...
      connectErrors: {
        ...
        identity:
          "The account identity could not be verified. Connect again with your own account.",
        authority:
