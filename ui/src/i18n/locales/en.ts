...
export const en: TranslationMap & {
  ...
  modelSetup: {
    ...
    wizard: {
      ...
      prepareDialogLabel: "Provider setup",
      title: "Sign in with a provider",
      prepareTitle: "Set up a provider",
      starting: "Starting provider sign-in…",
      prepareStarting: "Starting provider setup…",
  ...
  modelProviders: {
    ...
    add: {
      ...
      action: "Add provider",
      none: "No additional provider setup methods are available.",
      provider: "Provider",
      selectProvider: "Select a provider",
      save: "Configure provider",
      saved: "Provider {provider} configured.",
    },
    defaults: {
      title: "Defaults",
