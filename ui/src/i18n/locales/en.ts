...
export const en: TranslationMap = {
  ...
  memoryPage: {
    ...
    engine: {
      ...
      explicitHint: 'This engine is pinned in config under plugins.slots["memory.recall"].',
      offHint: 'Memory is switched off in config: plugins.slots["memory.recall"] is set to none.',
