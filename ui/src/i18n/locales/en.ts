...
export const en: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "Crab visits",
      crabVisitsOn: "Drops by occasionally",
      crabVisitsOff: "Never visits",
      crabSounds: "Crab sounds",
      crabSoundsOn: "Tiny blubs when touched",
      crabSoundsOff: "Silent",
      crabdex: "Crabdex",
      crabdexSeen: "{seen}/{total} visited",
      crabdexFirstVisited: "{name} · first visited {date}",
      crabdexCardFirstVisited: "First visited {date}",
      crabdexCardShinySeen: "✦ Shiny spotted {date}",
      crabdexCardCopyLink: "Copy link",
      crabdexOpen: "Open Crabdex",
    },
    security: {
  ...
  subtitles: {
    ...
    crabdex: "Every crab palette that has visited this browser.",
  ...
  chat: {
    ...
    progressLabels: {
      ...
      imprecating: "Imprecating",
      anathematizing: "Anathematizing",
      billingsgating: "Billingsgating",
