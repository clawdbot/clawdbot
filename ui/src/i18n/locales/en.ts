...
export const en: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      testQueued: "Test notification requested",
      ...
      nativeBlockedHint:
        "Allow OpenClaw notifications in your operating system's notification settings.",
      ...
      sessionOnly:
        "These device settings apply only to this Gateway connection and reset on reconnect. Connect with a Gateway user profile to save them.",
  ...
  subtitles: {
    ...
    notifications: "Notification delivery and preferences for this browser or app.",
