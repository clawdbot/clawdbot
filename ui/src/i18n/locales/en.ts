...
export const en: TranslationMap & {
  ...
  workboard: {
    ...
    detailWorkCompleted: "Work completed",
    detailThisAttempt: "This attempt",
    detailVerifiedThisAttempt: "Verified this attempt",
    detailOverallEvidence: "Overall evidence",
    detailVerification: "Verification",
    detailNoVerification: "No verification evidence has been attached yet.",
    detailRelatedWork: "Related work",
    detailArtifact: "Artifact",
    detailExecutionProgress: "Execution: {status} · {mode}",
    detailAttemptProgress: "Latest attempt: {status} · {model}",
    detailAttemptProgressNoModel: "Latest attempt: {status}",
    ...
    autopilotGuarded: "Autopilot: Guarded",
    dispatchSummary:
    ...
    live: "live",
    cardNeedsReview: "Needs review",
    cardReviewFallback: "Inspect the completed work and verification evidence.",
    cardVerificationCount: "{count} verification records",
    cardLatestProgress: "Latest progress",
    cardCompletedWork: "Completed",
    linkType: {
      parent: "Parent task",
      child: "Child task",
      blocks: "Blocks",
