...
export const en: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      accountDefaultsHint: "These choices follow your OpenClaw profile on every device.",
      installedApp: "This browser or app",
      installedAppHint:
        "Applies only to this browser profile or installed Home Screen app. Native OpenClaw app notifications are configured separately.",
      installedAppOwnerHint:
        "This Gateway has no durable user profile, so notification choices are stored with this browser or Home Screen app. Native OpenClaw app notifications are configured separately.",
      deliverDevice: "Deliver to this browser or app",
      notificationLabel: "Notification label",
      notificationLabelHint: "For example, Slot 1 or Production.",
      approvalRequested: "Approval requested",
      approvalResolved: "Approval resolved elsewhere",
      ...
      lockScreenDetailHint:
        "Private hides names and request details. Detailed content is sanitized.",
      private: "Private",
      ...
      onlyAgentsHint: "Comma-separated agent IDs. Leave empty for every authorized agent.",
      inherit: "Use account default",
      on: "On",
      off: "Off",
      inheritDetail: "Use account detail level",
      inheritQuietHours: "Use account quiet hours",
      allAgents: "All authorized agents",
      selectedAgents: "Only selected agents",
