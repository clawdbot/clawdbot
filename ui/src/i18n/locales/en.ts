...
export const en: TranslationMap & {
  ...
  cron: {
    ...
    runs: {
      ...
      originScheduled: "Scheduled — cron fire",
      originManual: "Manual run",
      originTriggerScript: "Trigger script fired",
      originOnExit: "On-exit watcher",
      originStream: "Stream batch",
