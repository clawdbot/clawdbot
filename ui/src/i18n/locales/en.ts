...
export const en: TranslationMap = {
  ...
  clawsPage: {
    refresh: "Refresh Claws",
    summaryLabel: "Claw lifecycle summary",
    versionCompact: "v{version}",
    unavailable: "Claws are not enabled on this Gateway.",
    disconnected: "Connect to the Gateway to inspect Claws.",
    loading: "Loading Claw lifecycle state…",
    empty: "No Claws have been applied.",
    healthy: "Healthy",
    ...
    errors: {
      invalidLifecycle: "Gateway returned an invalid Claw lifecycle response.",
      invalidCatalog: "Gateway returned an invalid ClawHub response.",
      invalidPlan: "Gateway returned an invalid Claw preview.",
      invalidOutcome: "Gateway returned an invalid Claw apply result.",
    },
    catalog: {
      title: "Discover Claws",
      subtitle: "Search ClawHub, inspect a package, and preview every change before applying it.",
      unavailable: "ClawHub discovery is not available on this Gateway.",
      placeholder: "Search by purpose or package name",
      searchLabel: "Search ClawHub",
      official: "Official",
    ...
    plan: {
      ...
      operations: {
        add: "Add this Claw as a new agent",
        update: "Update the selected Claw",
        remove: "Remove the selected Claw",
      },
      blocked: "Blocked",
      ready: "Ready",
      ...
      adminRequired: "Applying changes requires operator.admin access.",
    },
  },
  modelSetup: {
