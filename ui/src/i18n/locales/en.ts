...
export const en: TranslationMap = {
  ...
  chat: {
    ...
    composer: {
      ...
      voiceActivePlaceholder: "Send text while voice stays live",
      voiceCanvasLabel: "Voice conversation",
      voiceCanvasSubtitle: "Voice",
      voiceCanvasHint: "Speak naturally",
      endVoiceConversation: "End voice conversation",
      addToMessage: "Add to message",
      photoLibrary: "Photos",
      fileBrowser: "Files",
      takePhotoHint: "Take a photo",
      attachPhotoHint: "Choose from library",
      attachFileHint: "Browse files",
