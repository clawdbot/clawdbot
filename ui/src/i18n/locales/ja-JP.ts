...
export const ja_JP: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      crabVisits: "ロブスターの訪問",
      crabVisitsOn: "ときどき立ち寄る",
      crabVisitsOff: "訪問しない",
      crabSounds: "ロブスターのサウンド",
      crabSoundsOn: "触れると小さなブクブク音",
      crabSoundsOff: "サイレント",
      crabdex: "Crabdex",
      crabdexSeen: "{seen}/{total} 訪問済み",
      crabdexFirstVisited: "{name} · 初回訪問日 {date}",
      crabdexCardFirstVisited: "初回訪問 {date}",
      crabdexCardShinySeen: "✦ {date} にシャイニーを発見",
      crabdexCardCopyLink: "リンクをコピー",
      crabdexOpen: "Crabdex を開く",
    },
    security: {
  ...
  subtitles: {
    ...
    crabdex: "このブラウザーを訪れたすべてのロブスターパレット。",
