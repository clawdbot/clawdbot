...
- [ ] Infinite loaders rely on the global reduced-motion gate; shadow-DOM components must not bypass it, and opt-in decorative motion is gated to `no-preference`
