...
7. Check existing open PRs and author limits before publishing. Reuse and repair an existing candidate PR when it owns the same cause; when the account is at its cap, hold reviewed worktrees and finish or land already-open verified work first.
