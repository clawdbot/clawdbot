...
- apply one exact frozen local change or local test repair whose
  ...
  evidence, rollback digest, and focused validation are all bound, excluding
  repository-governance instruction files such as `AGENTS.md`, `CLAUDE.md`,
  `CODEX.md`, `GEMINI.md`, and recognized equivalents at every depth;
