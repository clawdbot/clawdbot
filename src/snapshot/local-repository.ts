...
async function inspectWindowsPathSecurity(
  ...
  const command = [
    ...
    // Load the Desktop module before Get-Acl so inherited PowerShell 7 paths cannot replace this fail-closed ACL probe.
    "Import-Module -Name ($PSHOME + '\\Modules\\Microsoft.PowerShell.Security\\Microsoft.PowerShell.Security.psd1') -Force",
