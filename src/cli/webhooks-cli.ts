...
export function registerWebhooksCli(program: Command) {
  ...
  gmail
    .command("setup")
    .description("Configure Gmail watch + Pub/Sub + OpenCrustacean hooks")
    ...
    .option("--hook-url <url>", "OpenCrustacean hook URL")
    .option("--hook-token <token>", "OpenCrustacean hook token")
