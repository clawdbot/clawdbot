...
describe("printDaemonStatus", () => {
  ...
  it("prints stale updater launchd job guidance", () => {
    ...
    expectMockLineContains(runtime.error, "Stale OpenCrustacean updater launchd job(s) detected.");
  ...
  it("prints CLI and gateway versions with readable guidance when they differ", () => {
    ...
    expectMockLineContains(runtime.error, "this OpenCrustacean command is version 2026.4.23");
    expectMockLineContains(
      runtime.error,
