...
const DEFAULT_TAGLINE = "All your chats, one OpenCrustacean.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a crab roll: messy, delicious, effective.",
  ...
  "OpenCrustacean Support will never DM you first. I, on the other hand, absolutely will.",
