...
export function registerPluginsCli(program: Command) {
  const plugins = program
    .command("plugins")
    .description("Manage OpenCrustacean plugins and extensions")
    .addHelpText(
      "after",
      () =>
  ...
  marketplace
    .command("entries")
    .description("List entries from the configured OpenCrustacean marketplace feed")
  ...
  marketplace
    .command("refresh")
    .description("Refresh the configured OpenCrustacean marketplace feed snapshot")
