...
import { isSessionWriteLockTimeoutOwnedByOtherReplyRun } from "../../agents/session-write-lock-owner.js";
...
export async function handleAgentExecutionError(params: {
  ...
  if (isSessionWriteLockTimeoutOwnedByOtherReplyRun(err, params.runId)) {
