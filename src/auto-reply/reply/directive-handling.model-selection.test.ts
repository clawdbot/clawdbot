// Model-selection scope resolution and authoritative model-lock rejections for
// mixed inline directives, split from directive-handling.mixed-inline.test.ts
// to stay under the file-size lint limit.
