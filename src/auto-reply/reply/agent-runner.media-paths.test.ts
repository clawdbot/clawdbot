...
describe("runReplyAgent media path normalization", () => {
  ...
  it("passes current inbound media paths as native OpenCrustacean images", async () => {
  ...
  it("does not pass recent history images as unlabeled native OpenCrustacean images", async () => {
