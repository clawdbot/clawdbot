...
const ACTIVE_GOAL_CONTEXT_SUFFIX =
  " — advance it; keep it active across unfinished steps; complete only when fully achieved; block only after the same blocker on 3 consecutive turns (get_goal/update_goal).";
