...
async function resolveModelDirective(params: {
  ...
  const result = await resolveReplyDirectives({
    ...
    preparedDefaultModel: { provider: "anthropic", model: "claude-opus-4-6" },
    preparedInitialModel: { provider: "anthropic", model: "claude-opus-4-6" },
    preparedPrimaryModel: { provider: "anthropic", model: "claude-opus-4-6" },
    provider: "anthropic",
