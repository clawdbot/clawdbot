...
describe("plugin sdk alias helpers", () => {
  ...
  it.each([
    {
      name: "does not derive plugin-sdk subpaths from cwd fallback when package root is not an OpenCrustacean root",
      fixture: () =>
  ...
  it.each([
    {
      name: "does not resolve plugin-sdk alias files from cwd fallback when package root is not an OpenCrustacean root",
      fixture: () =>
        createPluginSdkAliasFixture({
