...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    'export { type MatrixResolvedStringField, type MatrixResolvedStringValues, resolveMatrixAccountStringValues } from "../../../extensions/matrix/src/auth-precedence.js";',
    ...
    'export { hashMatrixAccessToken, resolveMatrixAccountStorageRoot, resolveMatrixCredentialsDir, resolveMatrixCredentialsFilename, resolveMatrixCredentialsPath, resolveMatrixHomeserverKey, sanitizeMatrixPathSegment } from "../../../extensions/matrix/src/storage-paths.js";',
    ...
    'export { setMatrixThreadBindingIdleTimeoutBySessionKey, setMatrixThreadBindingMaxAgeBySessionKey } from "../../../extensions/matrix/src/matrix/thread-bindings-shared.js";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "slack", relativePath: "runtime-api.ts" })]: [
    ...
    'export { registerSlackPluginHttpRoutes } from "../../../extensions/slack/src/http/plugin-routes.js";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export { buildTelegramExecApprovalPendingPayload, shouldSuppressTelegramExecApprovalForwardingFallback } from "../../../extensions/telegram/src/exec-approval-forwarding.js";',
      ...
      'export { parseTelegramTopicConversation } from "../../../extensions/telegram/src/topic-conversation.js";',
      'export { resolveTelegramPollVisibility } from "../../../extensions/telegram/src/poll-visibility.js";',
    ],
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "whatsapp", relativePath: "runtime-api.ts" })]:
    [
      'export { getActiveWebListener, resolveWebAccountId, type ActiveWebListener, type ActiveWebSendOptions } from "../../../extensions/whatsapp/src/active-listener.js";',
      ...
      'export { DEFAULT_WEB_MEDIA_BYTES, HEARTBEAT_PROMPT, HEARTBEAT_TOKEN, monitorWebChannel, SILENT_REPLY_TOKEN, stripHeartbeatToken, type WebChannelStatus, type WebMonitorTuning } from "../../../extensions/whatsapp/src/auto-reply.js";',
      ...
      'export { startWebLoginWithQr, waitForWebLogin } from "../../../extensions/whatsapp/login-qr-runtime.js";',
    ],
} as const;
...
describe("runtime api guardrails", () => {
  ...
  it("keeps the composed hook-runner registry internal", () => {
    ...
    expect(pluginRuntime).toContain(
      'export { getGlobalHookRunner } from "../hook-runner-global.js";',
    );
