...
describe("install security scan official bypass", () => {
  it("bypasses plugin install friction for bundled OpenCrustacean sources", async () => {
  ...
  it("bypasses skill install friction for bundled OpenCrustacean sources", async () => {
