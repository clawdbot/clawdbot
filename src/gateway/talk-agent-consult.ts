  ...
  >((resolve) => {
    ...
    const chatSendOptions = {
      ...
      params: {
        ...
        // The consult is an internal delegated run: format it as a system turn
        // and keep the synthetic orchestration text out of user-visible
        // history via the trusted internal dispatch below.
        message: formatSystemTurnPrompt(message),
        idempotencyKey,
        deliver: false,
    ...
    // Trusted internal dispatch keeps the synthetic consult input from being
    // persisted as a user-authored turn in history, exports, and compaction.
