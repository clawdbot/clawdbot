...
describe("resolveGatewayLiveModelThinkingLevel", () => {
  ...
  it.each(["gpt-5.6", "gpt-5.6-sol", "gpt-5.6-terra", "gpt-5.6-luna"])(
    "preserves OpenCrustacean Ultra for openai/%s",
    (id) => {
      expect(
...
describe("buildLiveGatewayConfig", () => {
  it("pins selected live gateway models to the OpenCrustacean runtime", () => {
              ...
              for (
                ...
                try {
                  toolText = await requestGatewayAgentText({
                    ...
                    modelKey,
                    message: strictReply
                      ? "OpenCrustacean live tool probe (local, safe): " +
