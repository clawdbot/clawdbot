...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["notifications.subscribe", "notifications", "operator.read", "2026.8"],
  ["notifications.unsubscribe", "notifications", "operator.read", "2026.8"],
  ["notifications.preferences.get", "notifications", "operator.read", "2026.8"],
  ["notifications.preferences.set", "notifications", "operator.write", "2026.8"],
  ["notifications.test", "notifications", "operator.read", "2026.8"],
