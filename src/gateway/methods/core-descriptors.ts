...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["node.pair.approve", "nodes", "operator.pairing", "<=2026.7", { controlPlaneWrite: true }],
  ["node.pair.reject", "nodes", "operator.pairing", "<=2026.7"],
  ["node.pair.remove", "nodes", "operator.pairing", "<=2026.7", { controlPlaneWrite: true }],
  ["device.pair.list", "devices", "operator.pairing", "<=2026.7"],
  ["device.pair.approve", "devices", "operator.pairing", "<=2026.7", { controlPlaneWrite: true }],
  ["device.pair.reject", "devices", "operator.pairing", "<=2026.7"],
  ["device.pair.remove", "devices", "operator.pairing", "<=2026.7", { controlPlaneWrite: true }],
  ["device.pair.rename", "devices", "operator.pairing", "2026.7"],
  ["device.token.rotate", "devices", "operator.pairing", "<=2026.7", { controlPlaneWrite: true }],
  ["device.token.revoke", "devices", "operator.pairing", "<=2026.7", { controlPlaneWrite: true }],
  [
