  ...
  it("maps normalized inbound facts into a finalized message context", async () => {
    const ctx = buildChannelInboundEventContext({
      ...
      route: {
        ...
        accountId: "acct",
        routeSessionKey: "agent:main:test:group:room-1",
        dispatchSessionKey: "agent:main:test:group:room-1:thread:thread-1",
    ...
    const expectedFields = {
      ...
      From: "test:user:u1",
      To: "test:room:room-1",
      SessionKey: "agent:main:test:group:room-1:thread:thread-1",
      SystemEventSessionKey: "agent:main:test:group:room-1",
      AgentId: "main",
      DmScope: "main",
      AccountId: "acct",
      ParentSessionKey: "agent:main:test:group",
