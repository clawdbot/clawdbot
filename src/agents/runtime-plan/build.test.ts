...
describe("AgentRuntimePlan", () => {
  ...
  it("keeps OpenCrustacean-owned tool-schema normalization reachable from the plan", () => {
    const plan = buildAgentRuntimePlan({
      provider: "openai",
      modelId: "gpt-5.4",
      modelApi: "openai-responses",
  ...
  it("forwards OpenAI Codex profiles for explicit OpenAI OpenCrustacean runs", () => {
    const plan = buildAgentRuntimePlan({
      provider: "openai",
      modelId: "gpt-5.4",
      modelApi: "openai-responses",
