...
import { copyEmbeddedRunCallAccountingObservers } from "../embedded-agent-runner/run/accounting-observers.js";
...
function buildRestrictedFinalizationAttempt(
  ...
  return copyEmbeddedRunCallAccountingObservers(attempt, {
