    ...
    execute: async (toolCallId, args, signal) => {
      ...
      const gateway: MessageActionGateway | undefined =
        options?.conversationReadOrigin === "direct-operator"
          ...
          : {
              ...
              connectionTarget: gatewayResolved.target,
      ...
      try {
        result = await runMessageActionForTool({
          ...
          agentId: resolvedAgentId,
          ...(options?.targetSessionProjectionCoordinator && !callerOwnsTerminalReceipt
            ? {
                targetSessionProjection: {
                  cfg: rawConfig,
                  readCurrentConfig: options.targetSessionProjectionCoordinator.readCurrentConfig,
                  coordinator: options.targetSessionProjectionCoordinator,
                },
              }
            : {}),
