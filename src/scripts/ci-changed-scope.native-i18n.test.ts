...
describe("native i18n changed scope", () => {
  ...
  it("keeps generated artifacts in isolated automation PRs", () => {
    ...
    const generatedPaths = [
      ...
      "apps/macos/Sources/OpenCrustacean/Resources/Localizable.xcstrings",
  ...
  it("runs strict parity only for manual or generated-artifact checks", () => {
    ...
    expect(
      shouldStrictNativeI18n(["apps/macos/Sources/OpenCrustacean/Resources/Localizable.xcstrings"]),
    ).toBe(true);
    expect(
