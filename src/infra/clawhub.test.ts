...
describe("clawhub helpers", () => {
  ...
  it("treats OpenCrustacean release correction versions as stable plugin API hosts", () => {
  ...
  it("checks min gateway versions with loose host labels", () => {
    ...
    expect(satisfiesGatewayMinimum("OpenCrustacean 2026.3.22", "2026.3.0")).toBe(true);
