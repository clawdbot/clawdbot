  ...
  const pendingEntries = flushPendingCoalescing
    ? [...pendingWakes.entries()].toSorted(
        ([leftTarget], [rightTarget]) =>
          Number(isUnscopedWakeTargetKey(leftTarget)) - Number(isUnscopedWakeTargetKey(rightTarget)),
      )
