...
export function resolveFutureConfigActionBlock(
  ...
  return {
    ...
    currentVersion,
    touchedVersion,
    message: `Refusing to ${params.action} because this OpenCrustacean binary (${currentVersion}) is older than the config last written by OpenCrustacean ${touchedVersion}.`,
    hints: [
