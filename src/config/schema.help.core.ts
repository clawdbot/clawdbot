...
export const CORE_FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.systemAgent.agentId":
    "Agent whose model and credentials own ambient system-agent and Custodian consults. Also used when models.list, models.authStatus, skills.status, doctor.memory.status, or an infer CLI command omits agentId or --agent; explicit request agentId always wins.",
