...
export const CORE_FIELD_HELP: Record<string, string> = {
  ...
  "gateway.remote.transport":
    'Remote connection transport: "direct" is the default for new macOS remote configurations and connects to a secure wss:// Gateway endpoint; "ssh" is the fallback tunnel transport.',
  "gateway.reload":
