...
export const AUTOMATION_FIELD_HELP: Record<string, string> = {
  ...
  "session.maintenance.highWaterBytes":
    "Target size after disk-budget cleanup (high-water mark). Defaults to 80% of maxDiskBytes; set explicitly for tighter reclaim behavior on constrained disks. Must be positive — a value that resolves to zero or less falls back to the default; disable the budget with maxDiskBytes instead.",
