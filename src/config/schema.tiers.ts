...
tools.media.models.*.request.auth.token tools.profile tools.profiles tools.profiles.*.alsoAllow tools.profiles.*.baseProfile tools.profiles.*.deny tools.sessions
