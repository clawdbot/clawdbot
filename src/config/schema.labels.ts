...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.usageBudget": "Default Usage Budget",
  "agents.defaults.usageBudget.daily.usd": "Daily Spend Warning (USD)",
  "agents.defaults.usageBudget.action": "Usage Budget Action",
  "agents.entries.*.usageBudget": "Agent Usage Budget",
