...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.loopDetection.turnLimit": "Max Assistant Turns",
  "tools.loopDetection.maxConsecutiveErrorBatches": "Max Consecutive Error Batches",
  "tools.loopDetection.maxIdleRepeatCalls": "Max Idle Repeat Calls",
  "agents.entries.*.tools.loopDetection.enabled": "Agent Tool-loop Detection",
  "agents.entries.*.tools.loopDetection.turnLimit": "Agent Max Assistant Turns",
  "agents.entries.*.tools.loopDetection.maxConsecutiveErrorBatches":
    "Agent Max Consecutive Error Batches",
  "agents.entries.*.tools.loopDetection.maxIdleRepeatCalls": "Agent Max Idle Repeat Calls",
