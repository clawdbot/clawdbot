...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.entries.*.modelSpend": "Agent Model Spend Alerts",
  "agents.entries.*.modelSpend.providers": "Tracked Model Providers",
  "agents.entries.*.modelSpend.dailyAlertEveryUsd": "Daily Spend Alert Interval (USD)",
