...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "commands.channelAdministrators": "Trusted Channel Administrators",
  "commands.channelAdministrators.*.channel": "Administrator Channel Provider",
  "commands.channelAdministrators.*.accountId": "Administrator Account ID",
  "commands.channelAdministrators.*.senderId": "Administrator Sender ID",
  "commands.channelAdministrators.*.conversationId": "Administrator Conversation ID",
