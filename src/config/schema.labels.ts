...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.embeddedAgent.runBudget": "Embedded Agent Run Budget",
  "agents.defaults.embeddedAgent.runBudget.maxModelTurns": "Run Budget Max Model Turns",
  "agents.defaults.embeddedAgent.runBudget.maxToolCalls": "Run Budget Max Tool Calls",
  "agents.defaults.embeddedAgent.runBudget.maxProviderAttempts": "Run Budget Max Provider Attempts",
  "agents.defaults.embeddedAgent.runBudget.maxOutputTokens": "Run Budget Max Output Tokens",
  "agents.defaults.embeddedAgent.runBudget.maxDurationSeconds": "Run Budget Max Duration (Seconds)",
  ...
  "agents.entries.*.embeddedAgent.runBudget": "Agent Run Budget",
  "agents.entries.*.embeddedAgent.runBudget.maxModelTurns": "Agent Max Model Turns",
  "agents.entries.*.embeddedAgent.runBudget.maxToolCalls": "Agent Max Tool Calls",
  "agents.entries.*.embeddedAgent.runBudget.maxProviderAttempts": "Agent Max Provider Attempts",
  "agents.entries.*.embeddedAgent.runBudget.maxOutputTokens": "Agent Max Output Tokens",
  "agents.entries.*.embeddedAgent.runBudget.maxDurationSeconds": "Agent Max Run Duration (Seconds)",
