...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.memory": "Memory Pressure Thresholds",
  "diagnostics.memory.rssWarningBytes": "RSS Warning (bytes)",
  "diagnostics.memory.rssCriticalBytes": "RSS Critical (bytes)",
  "diagnostics.memory.heapUsedWarningBytes": "V8 Heap Warning (bytes)",
  "diagnostics.memory.heapUsedCriticalBytes": "V8 Heap Critical (bytes)",
  "diagnostics.memory.rssGrowthWarningBytes": "RSS Growth Warning (bytes)",
  "diagnostics.memory.rssGrowthCriticalBytes": "RSS Growth Critical (bytes)",
