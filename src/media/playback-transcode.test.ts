...
describe("resolvePlaybackTranscode", () => {
  ...
  it.each([
    { kind: "audio", fileName: "clock-rollback.caf", mimeType: "audio/x-caf" },
    { kind: "video", fileName: "clock-rollback.webm", mimeType: "video/webm" },
  ] as const)(
    "retries failed $kind transcodes when the wall clock moves backward",
    async (media) => {
