...
function resolveThresholds(
  ...
  const heapUsedWarningBytes = thresholds?.heapUsedWarningBytes ?? DEFAULT_HEAP_WARNING_BYTES;
  const heapUsedCriticalBytes = thresholds?.heapUsedCriticalBytes ?? DEFAULT_HEAP_CRITICAL_BYTES;
