...
/** Candidate registry used only while migrating away from the legacy central inventory. */
export const ComposedProtocolSchemas = composeProtocolSchemaFragments([
