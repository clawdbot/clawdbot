...
export const TransportProtocolSchemas = {
  ...
  GatewaySuspendPreflightParams: gatewaySuspend.GatewaySuspendPreflightParamsSchema,
  GatewaySuspendPreflightCounts: gatewaySuspend.GatewaySuspendPreflightCountsSchema,
  GatewaySuspendPreflightResult: gatewaySuspend.GatewaySuspendPreflightResultSchema,
