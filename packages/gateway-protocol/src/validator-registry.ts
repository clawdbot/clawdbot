...
export const validateAgentResultGetParams = compile(S.AgentResultGetParamsSchema);
export const validateAgentCollectorSpawnParams = compile(S.AgentCollectorSpawnParamsSchema);
