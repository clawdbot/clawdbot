...
import {
  createFetchInvocationCompatibilityObservers,
...
> = (
  ...
  void (async () => {
    ...
    try {
      ...
      let observeSseFetchInvocation: (() => void) | undefined;
      const sseInvocationObservers = createFetchInvocationCompatibilityObservers(() =>
        observeSseFetchInvocation?.(),
      );
      const guardedSseFetch = buildGuardedModelFetchResult(model, undefined, {
        ...sseInvocationObservers,
      });
      ...
      for (let attempt = 0; attempt <= maxRetries; attempt++) {
        ...
        observeSseFetchInvocation = () => {
          ...
          transportAccounting.observeInvocation({
            attemptKey: invocationAttemptKey,
        ...
        try {
          ...
          observeSseFetchInvocation = undefined;
        }
