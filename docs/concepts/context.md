...
When truncation occurs, the runtime injects a concise in-prompt warning block under Project Context naming the truncated files and sizes. This notice is built in and not configurable.
