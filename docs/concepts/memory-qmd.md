...
indexed by the builtin engine on its next sync. QMD indexes, exported session Markdown, downloaded
models, and collection metadata are derived state and do not require migration.
