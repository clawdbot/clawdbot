...
| `openclaw/plugin-sdk/archive`           | Bounded archive extraction, private-directory regular-file alias materialization with joined extraction/copy cancellation, and single-entry reads                                  |
