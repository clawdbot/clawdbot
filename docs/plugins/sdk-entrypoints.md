...
| `openclaw/plugin-sdk/archive`           | Bounded archive extraction, private-directory regular-file alias materialization with joined timeout cleanup, and single-entry reads                                               |
