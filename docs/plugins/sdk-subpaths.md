...
are private-local.
  ...
  <Accordion title="Provider subpaths">
    ...
    | `plugin-sdk/embedding-provider-runtime-contract` | Typed contract for provider-owned text batching: `EmbeddingBatchChunk`, `EmbeddingBatchOptions`, and `EmbeddingProviderRuntime` with `batchEmbed(...)` and `sourceWideBatchEmbed` |
