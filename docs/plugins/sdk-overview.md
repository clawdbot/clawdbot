...
| `api.session.state.getSessionExtension(...)`                                         | Read one durable session-extension namespace owned by the current plugin                                                                                   |
| `api.session.state.setSessionExtension(...)` / `clearSessionExtension(...)`          | Persist or clear one durable session-extension namespace owned by the current plugin                                                                       |
