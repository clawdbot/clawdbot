...
| `workboard_repair_decomposition`                                                                                                                 | Dry-run by default; apply only proven legacy hard links created by decomposition. Preserves card status, comments, proof, artifacts, and history.                                                                                                                     |
...
| `workboard_decompose`                                                                                                                            | Fan a parent orchestration card into children, inheriting board/tenant metadata; children use non-blocking orchestration provenance by default, or explicit hard dependencies with `decompositionMode: "hard"`; can complete the parent with a created-card manifest. |
