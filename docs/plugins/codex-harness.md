...
| `requestTimeoutMs`                            | `60000`                                                | Timeout for app-server control-plane calls and WebSocket/Unix upgrade handshakes. A peer that accepts the socket but never completes the HTTP Upgrade exits with code `1006` after this budget.                                                                                                                                                                                                 |
