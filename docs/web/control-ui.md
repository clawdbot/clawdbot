...
Sidebar visibility belongs to the current tab and is not remembered across tabs, windows, or reloads; the sidebar's width is still remembered. A session opened in a new browser tab starts with the sidebar collapsed. Press ⌘B to reveal it.
