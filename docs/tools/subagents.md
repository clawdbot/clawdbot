...
<ParamField path="thinking" type="string">
  Override thinking level for the sub-agent run. With `visible: true`, the normalized level is persisted before the first turn.
</ParamField>
