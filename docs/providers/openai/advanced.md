...
<AccordionGroup>
  ...
  <Accordion title="Fast mode">
    ...
    [Context window defaults and long-context opt-in](/providers/openai/setup#context-window-defaults-and-long-context-opt-in).
    ChatGPT/Codex-credit Fast mode is a separate
