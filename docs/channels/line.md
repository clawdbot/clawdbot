...
```json5
{
  channels: {
    line: {
      ...
      channelSecret: { source: "file", provider: "mounted-json", id: "/channels/line/secret" },
      accounts: {
        support: {
