...
- Dropped messages do not generate read receipts or agent activity logs, but they are recorded as completed in the durable queue with a `reply_rate_suppressed` reason for diagnostics.
