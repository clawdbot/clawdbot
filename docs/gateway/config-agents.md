...
- `description`: optional human-authored capability summary. `agents_list` exposes a bounded version to models that may spawn this agent. Keep descriptions focused on capabilities; do not include secrets or tenant-sensitive information.
