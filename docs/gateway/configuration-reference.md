...
- `talk.*` (Talk mode)
  ...
  - `talk.idleTimeoutS`: seconds without recognized user speech or an assistant reply before macOS Talk deactivates; leave unset to disable idle auto-deactivation. iOS and Android ignore this field.
