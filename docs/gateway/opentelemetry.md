...
| `OTEL_PROPAGATORS`                                                                                                | Propagators kept active when `OTEL_SDK_DISABLED=true`. Defaults to `tracecontext,baggage`; `none` disables automatic propagation. Values are case-insensitive.                                                                                                                                                                              |
