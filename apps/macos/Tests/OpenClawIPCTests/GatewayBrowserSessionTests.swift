...
private final class BrowserSessionWebSocketRecorder: WebSocketSessioning, @unchecked Sendable {
    ...
    private lazy var session = GatewayTestWebSocketSession { [connectHasCredentials] in
...
struct GatewayConnectionBrowserSessionTests {
    @Test func `browser credential replacement retires route and never sends shared credentials`() async throws {
