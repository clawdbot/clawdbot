...
enum class GatewayMethod(
  ...
  ClawsCatalogSearch("claws.catalog.search"),
  ClawsCatalogDetail("claws.catalog.detail"),
  ClawsAddPlan("claws.add.plan"),
  ClawsAddApply("claws.add.apply"),
  ClawsUpdatePlan("claws.update.plan"),
  ClawsUpdateApply("claws.update.apply"),
  ClawsRemovePlan("claws.remove.plan"),
  ClawsRemoveApply("claws.remove.apply"),
  LogsTail("logs.tail"),
