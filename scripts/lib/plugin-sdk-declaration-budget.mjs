// Raised for the plugins.uninstall/catalog actions and absorbed session/plugin protocol surfaces;
// the cap exists to force a conscious decision on published declaration growth.
export const MAX_PUBLIC_PLUGIN_SDK_DECLARATION_BYTES = 5_205_000;
...
export const MAX_PRIVATE_QA_PUBLIC_PLUGIN_SDK_DECLARATION_BYTES = 5_230_000;
