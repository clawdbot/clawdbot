// Strict unified tsdown build measurement for the merged public plugin-sdk declaration graph.
export const MAX_PUBLIC_PLUGIN_SDK_DECLARATION_BYTES = 4_964_500;
// Strict unified tsdown measurement when private-QA entrypoints join the graph.
export const MAX_PRIVATE_QA_PUBLIC_PLUGIN_SDK_DECLARATION_BYTES = 4_992_643;
