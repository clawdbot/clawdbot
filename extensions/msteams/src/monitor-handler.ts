...
function asMSTeamsTurnContext(context: unknown): MSTeamsTurnContext {
  // SAFETY: Teams ActivityHandler callbacks supply the turn-context contract used here.
  return context as MSTeamsTurnContext;
}
