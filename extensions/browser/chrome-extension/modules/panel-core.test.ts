...
describe("browser copilot panel contracts", () => {
  ...
  it("derives only secure remote or loopback Gateway endpoints", () => {
    ...
    expect(normalizeGatewayUrl("ws://127.255.255.254:18789")).toBe("ws://127.255.255.254:18789/");
    expect(normalizeGatewayUrl("ws://128.0.0.1:18789")).toBeNull();
    expect(normalizeGatewayUrl("ws://127.0.0.1.evil.example:18789")).toBeNull();
