export default {
  ...
  workboard: {
    ...
    attachmentsLimits: "{count}/{max} attached · max 256 KiB each",
    attachmentsLimitsHelp: "Files are kept with the card and uploaded when you save.",
    attachmentsAdd: "Add files",
    attachmentsDrop: "Drop files here or paste from the clipboard",
    attachmentsStaged: "Staged attachments",
    attachmentsFileInfo: "{size} · {mime}",
    attachmentsRemove: "Remove {file}",
    attachmentsInspect: "Inspect {file}",
    attachmentsDownload: "Download {file}",
    attachmentsDelete: "Delete {file}",
    attachmentsDeleteConfirm: 'Delete attachment "{file}"?',
    attachmentsPreviewClose: "Close attachment preview",
    attachmentsPreviewPreparing: "Preparing preview…",
    attachmentsPreviewUnavailable:
      "Preview is unavailable for this file type. Download it to inspect the file.",
    attachmentsPruneWarning:
      "{existing} stored + {staged} staged · saving keeps the newest {max} and removes the oldest",
    attachmentsPruneConfirm:
      "This card has {existing} existing attachments and {staged} new files. Saving will keep the newest {max} attachments and remove the oldest. Continue?",
    attachmentsRejectedEmpty: "{file} is empty and was not added.",
    attachmentsRejectedInvalidName: "{file} has an invalid filename; use 1–240 characters.",
    attachmentsRejectedTooLarge: "{file} exceeds the 256 KiB attachment limit.",
    attachmentsRejectedTooMany: "A card can have at most 20 attachments.",
