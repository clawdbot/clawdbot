...
function readProof(db: DatabaseSync, cardId: string, preloaded?: CardChildRows): WorkboardProof[] {
  return childRows(db, "workboard_card_proof", cardId, preloaded).map((child) => {
