...
// (data, catalogue, workflows, ...) that the vctraderai read-only tools call.
// Any non-allowlisted path is rejected before a socket is opened, so a buggy
// or malicious tool body cannot reach admin/system surfaces by accident.
//
