...
export const QA_SUBAGENT_PARENT_VISIBLE_PROMPT_RE = /reply to the requester after spawning/i;
...
export const QA_SUBAGENT_PARENT_VISIBLE_MARKER = "QA-SUBAGENT-PARENT-ACK";
