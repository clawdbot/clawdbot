...
import { runGetBrokerDeals } from "./index.js";
import {
  BffEgressViolation,
  createBffFetch,
...
describe("vctraderai-get-broker-deals egress allowlist", () => {
  ...
  it("every captured url on the happy path matches the workspace-scoped allowlist", async () => {
    ...
    await runGetBrokerDeals({ account_id: "account_id-x", hours: 24 }, { fetchImpl });
