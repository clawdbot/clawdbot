...
export const buildTokenHubModelDefinition = buildManifestModelDefinition({
...
/** @deprecated Use buildManifestModelDefinition. */
export const buildTokenPlanModelDefinition = buildManifestModelDefinition({
...
export const TOKENPLAN_MODEL_CATALOG: ModelDefinitionConfig[] =
  TOKENPLAN_MANIFEST_CATALOG.models.map(buildTokenPlanModelDefinition);
