...
import { runGetLiveQuotes } from "./index.js";
import {
  BffEgressViolation,
  createBffFetch,
...
describe("vctraderai-get-live-quotes egress allowlist", () => {
  ...
  it("every captured url on the happy path matches the workspace-scoped allowlist", async () => {
    ...
    await runGetLiveQuotes({ account_id: "account_id-x", symbols: "EURUSD,XAUUSD" }, { fetchImpl });
